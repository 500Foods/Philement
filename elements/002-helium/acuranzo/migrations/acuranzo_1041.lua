...
cfg.MIGRATION = "1041"
cfg.LOOKUP_ID = "016"
cfg.LOOKUP_NAME = "Account Access Type"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Categorizes account access types.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'Automated',   0, 0, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Active',      0, 1, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 2, 1, 'Suspended',   0, 2, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 3, 1, 'Expired',     0, 3, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 4, 1, 'Terminated',  0, 4, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 5, 1, 'Blocked',     0, 5, '', '', '{}', ${COMMON_VALUES});
