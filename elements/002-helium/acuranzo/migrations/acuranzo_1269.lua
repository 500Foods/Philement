-- Migration: acuranzo_1269.lua
-- QueryRef #134 - Soft-disable OAuth Client (OIDC IdP)
...
cfg.MIGRATION = "1269"
cfg.QUERY_REF = "134"
cfg.QUERY_NAME = "Soft-disable OAuth Client"
    ...
    SELECT
        ...
        [=[
            ...
            SELECT
                ...
                ${TIMEOUT}                                                          AS query_timeout,
                [==[
                    UPDATE ${SCHEMA}oauth_clients
                       SET status_a12 = ${STATUS_INACTIVE},
                           updated_id = 0,
                           updated_at = ${NOW}
                ...
                [==[
                    ...
                    Soft-disables an OAuth client (status inactive). Does not
                    delete the row so historical codes/tokens remain attributable.
