...
table.insert(queries,{sql=[[
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'No',  0, 0, '', '', ${JIS}[==[{"icon":"<fa fa-xmark fa-swap-opacity style='color: #FF0000; filter: var(--ACZ-shadow-4);'></fa>"}]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Yes', 0, 1, '', '', ${JIS}[==[{"icon":"<fa fa-check fa-swap-opacity style='color: #00FF00; filter: var(--ACZ-shadow-4);'></fa>"}]==]${JIE}, ${COMMON_VALUES});
