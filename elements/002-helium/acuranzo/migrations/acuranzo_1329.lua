-- Migration: acuranzo_1329.lua
-- PRIORITIZE 2.9: Enroll.PaidCourse appends enrollment_events
--
-- Do not restamp 1318. After a new paid/renew Helium grant, require Enroll.LogEvent.
--
-- luacheck: no max line length
-- luacheck: no unused args
--
-- CHANGELOG
-- 1.0.0 - 2026-08-20 - PaidCourse logs enrolment events (PRIORITIZE 2.9)
...
return M
            ...
            WHERE query_ref = ${MIGRATION}
              and query_type_a28 = ${TYPE_FORWARD_MIGRATION};
                                                                            ...
                                                                            AS code,
        'PaidCourse logs enrollment_events'                                                AS name,
        [=[
            # Forward Migration ${MIGRATION}: Enroll.PaidCourse LogEvent\n\n            After a new paid or renew grant, `record` purchased/renewed. Existing order-line rows stay silent. Canvas PUT is best-effort.
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
        ${COMMON_INSERT}
...
return M
            ...
            WHERE query_ref = ${MIGRATION}
              and query_type_a28 = ${TYPE_APPLIED_MIGRATION};
                                                                            ...
                                                                            AS code,
        'Restore Enroll.PaidCourse prior body'                 AS name,
        [=[
