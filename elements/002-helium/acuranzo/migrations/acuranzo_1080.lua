-- Migration: acuranzo_1080.lua
-- Defaults for Lookup 047 - Translations
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Translations. This is used mostly for UI work.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID},  0, 1, 'Column Chooser', 0, 0, '', '', ${JIS}[==[{"en-US": "Sélecteur de colonnes", "fr-FR": "Sélecteur de colonnes", "Default": "Column Chooser"}]==]${JIE}, ${COMMON_VALUES});
