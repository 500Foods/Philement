    ...
    SELECT
        ...
        [=[
            ...
            (
                ...
                1,
                '[%COUNT%x] MailRelayEvent server_started %SERVER_NAME%',
                'Server %SERVER_NAME% (%APP_NAME%) started at %TIMESTAMP%.\n%SUMMARY%',
                '<p>Server %SERVER_NAME% (%APP_NAME%) started at %TIMESTAMP%.</p><p>%SUMMARY%</p>',
                '{}',
                ${COMMON_VALUES}
            ),
            (
                ...
                1,
                '[%COUNT%x] MailRelayEvent databases_ready %SERVER_NAME%',
                'Databases ready on %SERVER_NAME% (%APP_NAME%) at %TIMESTAMP%.\n%SUMMARY%',
                '<p>Databases ready on %SERVER_NAME% (%APP_NAME%) at %TIMESTAMP%.</p><p>%SUMMARY%</p>',
                '{}',
                ${COMMON_VALUES}
            ),
            (
