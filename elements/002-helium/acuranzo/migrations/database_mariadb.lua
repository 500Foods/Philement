...
return {
    ...
    -- MariaDB doesn't require FROM clause for SELECT without tables
    DUMMY_TABLE = "",
    ...
    -- MariaDB UDF for Brotli decompression
    ...
    -- Schema ingest: MariaDB's JSON_VALID has no reserved-key semantics, so JSON Schema
