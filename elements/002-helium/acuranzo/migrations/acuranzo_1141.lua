...
cfg.MIGRATION = "1141"
cfg.QUERY_REF = "050"
cfg.QUERY_NAME = "Check Username/Email Availability"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
table.insert(queries,{sql=[[
    ...
    SELECT
        ...
        [=[
            ...
            SELECT
                ...
                [==[
                    ...
                    - `username_count`: Number of accounts with the specified username (0 = available)
                    - `email_count`: Number of accounts with the specified email (0 = available)
        ...
        [=[
            ...
            This migration creates the query for checking username and email availability during registration.
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
        ${COMMON_INSERT}
