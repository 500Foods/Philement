-- Migration: acuranzo_1181.lua
-- LithiumTable user-profile-sections (lookup_id 059, key_idx 4)
...
cfg.LOOKUP_ID = "059"
cfg.KEY_IDX = "4"
cfg.TABLEDEF_NAME = "user-profile-sections"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                ...
                [==[
                    # User Profile Sections tableDef
