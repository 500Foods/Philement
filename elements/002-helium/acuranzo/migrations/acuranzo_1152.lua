...
-- Defaults for Lookup 059 - Tabulator Schemas
...
cfg.MIGRATION = "1152"
cfg.LOOKUP_ID = "059"
cfg.LOOKUP_NAME = "Tabulator Schemas"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
            ...
            VALUES (
                ...
                [==[
                    ...
                    - **Key 0**: Column Types Schema (`coltypes.json`)
                      Defines all available column types including formatters, editors, sorters,
                      and display properties. Used as the base configuration for all table columns.

                    - **Key 1**: Query Manager Table Definition (`query-manager.json`)
                      Defines the column layout and configuration for the Query Manager table.
                      References coltypes and adds query-specific overrides.
