...
cfg.MIGRATION = "1029"
cfg.LOOKUP_ID = "004"
cfg.LOOKUP_NAME = "Connection Type"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Categorizes connection types like SSO and so on.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'SSO',     0, 0, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'JWT',     0, 1, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 2, 1, 'REST',    0, 2, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 3, 1, 'OATH',    0, 3, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 4, 1, 'LDAP',    0, 4, '', '', '{}', ${COMMON_VALUES});
