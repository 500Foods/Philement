-- Migration: acuranzo_1077.lua
-- Defaults for Lookup 044 - Server Version History
...
cfg.MIGRATION = "1077"
cfg.LOOKUP_ID = "044"
cfg.LOOKUP_NAME = "Server Version History"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
table.insert(queries,{sql=[[
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, '0.0.1', 0, 0, '', '<h3>{ACZ.SERVER}&nbsp; Version 0.0.1</h3><ul><li>Initial setup</li></ul>', ${JIS}[==[{"New": true, "Focus": "Startup", "Released": "2024-03-01"}]==]${JIE}, ${COMMON_VALUES});
