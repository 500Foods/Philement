...
cfg.MIGRATION = "1045"
cfg.LOOKUP_ID = "020"
cfg.LOOKUP_NAME = "Contact Status"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                ...
                (${LOOKUP_ID}, 2, 1, 'Former',      0, 2, '', '', ${JIS}[==[{"Icon":"<i class='fa fa-xmark fa-fw fa-swap-opacity' style='color: #FFFF00; filter: var(--ACZ-shadow-4);'></i>"}]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID}, 3, 1, 'Prospect',    0, 3, '', '', ${JIS}[==[{"Icon":"<i class='fa fa-check fa-fw fa-swap-opacity' style='color: #00FFFF; filter: var(--ACZ-shadow-4);'></i>"}]==]${JIE}, ${COMMON_VALUES});
