    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                ...
                (${LOOKUP_ID}, 2, 1, 'Former',      0, 2, '', '', ${JIS}[==[{"icon":"<fa fa-xmark fa-swap-opacity style='color: #FFFF00; filter: var(--ACZ-shadow-4);'></fa>"}]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID}, 3, 1, 'Prospect',    0, 3, '', '', ${JIS}[==[{"icon":"<fa fa-check fa-swap-opacity style='color: #00FFFF; filter: var(--ACZ-shadow-4);'></fa>"}]==]${JIE}, ${COMMON_VALUES});
