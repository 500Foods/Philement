-- Migration: acuranzo_1146.lua
-- QueryRef #053 - Get Themes

-- luacheck: no max line length
-- luacheck: no unused args

-- CHANGELOG
-- 1.0.0 - 2026-01-13 - Initial creation
        ...
        [=[
            ...
            SELECT
                ...
                [==[
                    ...
                    This public query returns the enabled themes (CSS) from the lookups table.
                    ...
                    - `key_idx`: The key index of the theme.
                    - `value_txt`: The name of the theme.
                    - `sort_seq`: The sort sequence of the theme.
                    - `code`: The CSS code of the theme.
                    ...
                    that it doesn't unduly impact the database performance. As themes don't
