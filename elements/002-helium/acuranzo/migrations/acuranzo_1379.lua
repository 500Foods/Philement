-- Migration: acuranzo_1379.lua
-- Addition to Lookup 048 - Module Groups (Learning)
...
table.insert(queries,{sql=[[
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                (${LOOKUP_ID},  6, 1, 'Learning',       0, 6, '', '', ${JIS}[==[{}]==]${JIE}, ${COMMON_VALUES});
        ...
        [=[
            ...
            Adds key_idx 6 'Learning' to Lookup 048 - Module Groups.
            This group contains Course Manager (34) and Course Builder (35) modules.
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
        ${COMMON_INSERT}
