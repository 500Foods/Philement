-- Migration: acuranzo_1236.lua
-- QueryRef #106 - Update Mail Template
...
cfg.MIGRATION = "1236"
cfg.QUERY_REF = "106"
cfg.QUERY_NAME = "Update Mail Template"
-- ----------------------------------------------------------------------------
-- Forward: Populate QueryRef #106 - Update Mail Template
-- ----------------------------------------------------------------------------
table.insert(queries,{sql=[[
    ...
    SELECT
        ...
        [=[
            ...
            SELECT
                ...
                [==[
                    ...
                    Updates an existing mail template. The `template_id`
                    identifies the row to update; all other fields are
                    replaced.

                    ## Parameters

                    - `TEMPLATE_ID` (integer, required): Template row to update.
        ...
        [=[
            ...
            This migration creates the internal UPDATE query for mail templates
            (QueryRef #${QUERY_REF}).
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
...
-- ----------------------------------------------------------------------------
-- Reverse: Remove QueryRef #106 - Update Mail Template
-- ----------------------------------------------------------------------------
table.insert(queries,{sql=[[
