-- Migration: acuranzo_1344.lua
-- PRIORITIZE 2.1: replace Enroll.FreeCourse
--
-- luacheck: no max line length
-- luacheck: no unused args
--
-- CHANGELOG
-- 1.0.0 - 2026-08-21 - FreeCourse find-dont-create
...
return succeed(eerr == "already", canvas_user_id, canvas_course_id)
            ...
            WHERE query_ref = ${MIGRATION}
              and query_type_a28 = ${TYPE_FORWARD_MIGRATION};
                                                                            ...
                                                                            AS code,
        'FreeCourse find-dont-create'                                                       AS name,
        [=[
            # Forward Migration ${MIGRATION}: FreeCourse find-dont-create

            PRIORITIZE 2.1. Do not restamp 1328. Find JIT user or fail not_provisioned; never create.
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
        ${COMMON_INSERT}
...
return succeed(eerr == "already", canvas_user_id, canvas_course_id)
            ...
            WHERE query_ref = ${MIGRATION}
              and query_type_a28 = ${TYPE_APPLIED_MIGRATION};
                                                                            ...
                                                                            AS code,
        'Restore prior Enroll.FreeCourse body'                               AS name,
        [=[
            # Reverse Migration ${MIGRATION}: restore prior FreeCourse

            Restores the pre-2.1 Enroll.FreeCourse body.
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
        ${COMMON_INSERT}
