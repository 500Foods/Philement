    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                ...
                (${LOOKUP_ID}, 1, 1, 'Access',          0, 1, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 2, 1, 'Admin Access',    0, 2, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 3, 1, 'Super Access',    0, 3, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 4, 1, 'System Access',   0, 4, '', '', '{}', ${COMMON_VALUES});
