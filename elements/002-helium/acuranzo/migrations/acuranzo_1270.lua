-- Migration: acuranzo_1270.lua
-- QueryRef #135 - List Active OAuth Clients (OIDC IdP)
...
cfg.MIGRATION = "1270"
cfg.QUERY_REF = "135"
cfg.QUERY_NAME = "List Active OAuth Clients"
            ...
            SELECT
                ...
                [==[
                    SELECT client_id,
                     ...
                     WHERE status_a12 = ${STATUS_ACTIVE}
                     ORDER BY client_id
                ]==]                                                                AS code,
                '${QUERY_NAME}'                                                     AS name,
                [==[
                    ...
                    Lists active OAuth clients (no secrets). For admin tooling.
