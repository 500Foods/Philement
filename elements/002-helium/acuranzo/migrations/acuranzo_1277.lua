-- Migration: acuranzo_1277.lua
-- QueryRef #140 - Get OAuth Refresh Token (OIDC IdP)
...
cfg.MIGRATION = "1277"
cfg.QUERY_REF = "140"
cfg.QUERY_NAME = "Get OAuth Refresh Token"
    ...
    SELECT
        ...
        [=[
            ...
            SELECT
                ...
                ${TIMEOUT}                                                          AS query_timeout,
                [==[
                    SELECT token_hash, client_id, account_id, scope, family_id,
                ...
                [==[
                    ...
                    Loads refresh token by hash. Parameters: TOKEN_HASH.
                ]==]
                                                                                      AS summary,
                '{}'                                                                AS collection,
                ${COMMON_INSERT}
