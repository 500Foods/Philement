...
table.insert(queries,{sql=[[
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'Disconnected',    0, 0, '', '', ${JIS}[==[{"icon":"<fa fa-xmark fa-fw fa-swap-opacity style='color: #FF0000; filter: var(--ACZ-shadow-4);'></fa>"}]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Connected',       0, 1, '', '', ${JIS}[==[{"icon":"<fa fa-check fa-fw fa-swap-opacity style='color: #00FF00; filter: var(--ACZ-shadow-4);'></fa>"}]==]${JIE}, ${COMMON_VALUES});
