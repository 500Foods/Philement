...
cfg.MIGRATION = "1030"
cfg.LOOKUP_ID = "005"
cfg.LOOKUP_NAME = "Connected Status"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Categorizes connected status as disconnected or connected.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'Disconnected',    0, 0, '', '', ${JIS}[==[{"Icon":"<i class='fa fa-xmark fa-fw fa-swap-opacity' style='color: #FF0000; filter: var(--ACZ-shadow-4);'></i>"}]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Connected',       0, 1, '', '', ${JIS}[==[{"Icon":"<i class='fa fa-check fa-fw fa-swap-opacity' style='color: #00FF00; filter: var(--ACZ-shadow-4);'></i>"}]==]${JIE}, ${COMMON_VALUES});
