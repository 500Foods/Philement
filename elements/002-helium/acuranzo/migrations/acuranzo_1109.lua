...
-- CHANGELOG
-- 1.1.0 - 2026-07-09 - Use <=/>= for valid_after/valid_until so same-second JWT rows match on SQLite second-resolution timestamps (Test 40 renew, Test 58 SQLite STARTTLS)
