...
cfg.MIGRATION = "1038"
cfg.LOOKUP_ID = "013"
cfg.LOOKUP_NAME = "License Status"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                ...
                (${LOOKUP_ID}, 1, 1, 'Active',      0, 1, '', '', ${JIS}[==[{"Icon":"<i class='fa fa-xmark fa-fw fa-swap-opacity' style='color: #FF0000; filter: var(--ACZ-shadow-4);'></i>"}]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID}, 2, 1, 'Revoked',     0, 2, '', '', ${JIS}[==[{"Icon":"<i class='fa fa-check fa-fw fa-swap-opacity' style='color: #00FF00; filter: var(--ACZ-shadow-4);'></i>"}]==]${JIE}, ${COMMON_VALUES});
