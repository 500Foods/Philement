-- Migration: acuranzo_1057.lua
-- Defaults for Lookup 032 - List Status
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    List Status as excluded or included.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'Excluded', 0, 0, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Included', 0, 1, '', '', '{}', ${COMMON_VALUES});
