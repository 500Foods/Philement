-- Migration: acuranzo_1091.lua
-- Defaults for Lookup 058 - Query Queues
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Queue names. Maybe other variations will be added in future.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID},  0, 1, 'Lead',       0, 0, '', '', ${JIS}[==[ {} ]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID},  1, 1, 'Slow',       0, 0, '', '', ${JIS}[==[ {} ]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID},  2, 1, 'Medium',     0, 0, '', '', ${JIS}[==[ {} ]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID},  3, 1, 'Fast',       0, 0, '', '', ${JIS}[==[ {} ]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID},  4, 1, 'Cached',     0, 0, '', '', ${JIS}[==[ {} ]==]${JIE}, ${COMMON_VALUES});
