-- Migration: acuranzo_1040.lua
-- Defaults for Lookup 015 - System Access Type
...
cfg.MIGRATION = "1040"
cfg.LOOKUP_ID = "015"
cfg.LOOKUP_NAME = "System Access Type"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Categorizes system access types.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'No Access',       0, 0, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Local Access',    0, 1, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 2, 1, 'Client Access',   0, 2, '', '', '{}', ${COMMON_VALUES});
