...
table.insert(queries,{sql=[[
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                (${LOOKUP_ID},   0, 1, 'Undefined',                     0, 0, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID},   1, 1, 'System',                        0, 1, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID},   2, 1, 'Login Attempt',                 0, 2, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID},   3, 1, 'Login Successful',              0, 3, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID},   4, 1, 'Login Passed',                  0, 4, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 100, 1, 'ENdpoint: SystemService/Login', 0, 5, '', '', '{}', ${COMMON_VALUES});
