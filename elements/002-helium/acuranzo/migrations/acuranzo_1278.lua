-- Migration: acuranzo_1278.lua
-- QueryRef #141 - Revoke OAuth Refresh Token (OIDC IdP)
...
cfg.MIGRATION = "1278"
cfg.QUERY_REF = "141"
cfg.QUERY_NAME = "Revoke OAuth Refresh Token"
        ...
        [=[
            ...
            SELECT
                ...
                [==[
                    ...
                    Revokes one refresh token. Parameters: TOKEN_HASH.
                ]==]
                                                                                      AS summary,
                '{}'                                                                AS collection,
                ${COMMON_INSERT}
