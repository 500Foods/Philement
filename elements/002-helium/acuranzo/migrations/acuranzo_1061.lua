-- Migration: acuranzo_1061.lua
-- Defaults for Lookup 036 - Role Type
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Role Type - the type of role being assigned.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'Project Manager', 0, 0, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Auditor',         0, 1, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 2, 1, 'SME',             0, 2, '', '', '{}', ${COMMON_VALUES});
