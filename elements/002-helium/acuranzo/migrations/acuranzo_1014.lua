...
-- 1.0.0 - 2025-09-13 - Initial creation for notes table with PostgreSQL support.
    ...
    VALUES (
        ...
        [=[
            ...
            (
                ...
                entity_type_a9          ${INTEGER}          NOT NULL,
        ...
        [=[
            ...
            This migration creates the ${TABLE} table for storing note data.
        ]=],
                                                                            -- summary
        NULL,                                                               -- collection
        ${COMMON_INSERT}
