-- Migration: acuranzo_1183.lua
-- LithiumTable lookups-manager-list (lookup_id 059, key_idx 6)
...
cfg.LOOKUP_ID = "059"
cfg.KEY_IDX = "6"
cfg.TABLEDEF_NAME = "lookups-manager-list"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
