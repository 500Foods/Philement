-- Migration: acuranzo_1104.lua
-- QueryRef #013 - Store JWT
        ...
        [=[
            ...
            SELECT
                ...
                [==[
                    ...
                    This query stores a JWT token hash along with associated metadata
                    ...
                    - Rows affected: The number of rows inserted into the `tokens` table.

                    ## Tables

                    - `${SCHEMA}tokens`: The table where JWT token hashes and metadata are stored.
