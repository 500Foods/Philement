-- Migration: acuranzo_1117.lua
-- QueryRef #026 - Get Lookup
        ...
        [=[
            ...
            SELECT
                ...
                [==[
                    ...
                    This query retrieves lookup entries based on a specified lookup ID,
                    filtering by validity dates and ordering the results.
