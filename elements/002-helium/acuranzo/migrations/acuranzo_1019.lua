...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --       
        {
            sql =   [[
                        ...
                        VALUES (
                            ...
                            %%DIALECT%%,                                -- query_dialect_lua_30    
                            'Diagram Tables: %%SCHEMA%%systems',        -- name, summary
                            [=[
                                # Diagram Migration 1019

                                ## Diagram Tables: %%SCHEMA%%systems

                                This is the first JSON Diagram code for the systems table.
                            ]=],
