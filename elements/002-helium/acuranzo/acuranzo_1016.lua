...
-- CHANGELOG
-- 1.0.0 -0 2025-09-13 - Initial creation for roles table with PostgreSQL support.
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --        
        {
            sql =   [[
                        ...
                        VALUES (
                            ...
                            'Create Roles Table Query',         -- name, summary, query_code
                            [=[
                                # Forward Migration 1016: Create Roles Table Query
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --        
        {
            sql =   [[
                        ...
                        VALUES (
                            ...
                            %%DIALECT%%,                        -- query_dialect_lua_30    
                            'Delete Roles Table Query',         -- name, summary, query_code
                            [=[
                                # Reverse Migration 1016: Delete Roles Table Query
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --       
        {
            sql =   [[
                        ...
                        VALUES (
                            ...
                            %%DIALECT%%,                        -- query_dialect_lua_30    
                            'Diagram Roles Table Query',        -- name, summary
                            [=[
                                # Diagram Migration 1016: Diagram Roles Table Query

                                This is the PlantUML code for the roles table. 
                            ]=],
