...
| ---- | ------- | --------- | --------- | ------- | --------- | ------------- |
| [3000](/elements/002-helium/glm/migrations/glm_3000.lua) | queries | 3.4.0 | 2026-09-19 | 10 | ✓ | Bootstraps the migration system by creating the queries table and supporting user-defined functions |
| **1** | | | | **10** | **1** | |
