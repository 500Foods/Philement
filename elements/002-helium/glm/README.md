...
| ---- | ------- | --------- | --------- | ------- | --------- | ------------- |
| [3000](/elements/002-helium/glm/migrations/glm_3000.lua) | queries | 3.1.0 | 2025-11-23 | 9 | ✓ | Bootstraps the migration system by creating the queries table and supporting user-defined functions |
| **1** | | | | **9** | **1** | |
