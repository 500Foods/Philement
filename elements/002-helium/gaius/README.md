...
| ---- | ------- | --------- | --------- | ------- | --------- | ------------- |
| [2000](/elements/002-helium/gaius/migrations/gaius_2000.lua) | queries | 3.2.0 | 2026-09-16 | 9 | ✓ | Bootstraps the migration system by creating the queries table and supporting user-defined functions |
| **1** | | | | **9** | **1** | |
