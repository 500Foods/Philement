...
foreach(SOURCE_FILE ${UNITY_HYDROGEN_SOURCES})
    ...
    elseif(IS_POSTGRESQL_SOURCE GREATER -1)
        set(MOCK_INCLUDES "-I${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks")
        set(MOCK_DEFINES "-DUSE_MOCK_LIBPQ" "-DUSE_MOCK_SYSTEM" "-include" "${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks/mock_system.h")
    elseif(IS_MYSQL_SOURCE GREATER -1)
        set(MOCK_INCLUDES "-I${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks")
        set(MOCK_DEFINES "-DUSE_MOCK_LIBMYSQLCLIENT" "-DUSE_MOCK_SYSTEM" "-include" "${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks/mock_system.h")
    elseif(IS_DB2_SOURCE GREATER -1)
        set(MOCK_INCLUDES "-I${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks")
        set(MOCK_DEFINES "-DUSE_MOCK_LIBDB2" "-DUSE_MOCK_SYSTEM" "-include" "${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks/mock_system.h")
    elseif(IS_SQLITE_SOURCE GREATER -1)
        set(MOCK_INCLUDES "-I${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks")
        set(MOCK_DEFINES "-DUSE_MOCK_LIBSQLITE3" "-DUSE_MOCK_SYSTEM" "-include" "${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks/mock_system.h")
    ...
    elseif(IS_BOOTSTRAP_SOURCE GREATER -1)
        set(MOCK_INCLUDES "-I${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks")
        set(MOCK_DEFINES "-DUSE_MOCK_DATABASE_ENGINE" "-DUSE_MOCK_SYSTEM" "-include" "${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks/mock_system.h" "-include" "${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks/mock_database_engine.h")
    ...
    elseif(IS_QUEUE_SOURCE GREATER -1)
        set(MOCK_INCLUDES "-I${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks")
        set(MOCK_DEFINES "-DUSE_MOCK_SYSTEM" "-include" "${CMAKE_CURRENT_SOURCE_DIR}/../tests/unity/mocks/mock_system.h")
    else()
        set(MOCK_INCLUDES "")
        set(MOCK_DEFINES "")
    endif()
