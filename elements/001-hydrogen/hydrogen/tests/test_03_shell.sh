...
declare -a ENV_WHITELIST=(
    ...
    "API_CTX" "DB_CONNS_CLOSED" "DB_CONNS_CREATED" "IN_FLIGHT" "NAC" "NATIVE_METRICS" "NATIVE_MIDPOINT_REQUEST"
    "NATIVE_PID" "NATIVE_RESULT" "NATIVE_SNAPSHOT_INTERVAL"
    "NATIVE_SUFFIX" "NATIVE_TOTAL_REQUESTS" "NCL" "ND" "NDC" "NF" "NFH" "NFN" "NF_F" "NF_MB" "NF_Q" "NF_RSS" "NG_MB"
    "NI" "NM" "NP" "NPE" "NPH" "NPM" "NQ" "NR" "NRT" "NR_MB" "NSG" "NSH" "NSK" "N_CNT" "N_INIT" "N_INIT_F" "N_INIT_MB" "N_INIT_Q"
    "N_INIT_RSS" "N_MID" "PREP_CACHE" "PREP_EVICT" "PREP_HITS" "PREP_MISSES" "RELEASE_BIN" "SAVED_HYDROGEN_BIN"
    "NATIVE_GROWTH_DISPLAY" "NATIVE_STEADY_BYTES_PER_REQ" "NSB" "SCRAPE_CURL_TIMEOUT" "SCRAPE_MAX_ATTEMPTS" "SCRAPE_RETRY_DELAY"
