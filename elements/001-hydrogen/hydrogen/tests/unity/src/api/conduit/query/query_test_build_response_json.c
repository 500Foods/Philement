...
void test_build_response_json_error_case(void) {
    ...
    json_t* response = build_response_json(123, "test_db", &cache_entry, &selected_queue, &pending, NULL, NULL);
...
void test_build_response_json_null_pending(void) {
    ...
    json_t* response = build_response_json(789, "test_db", &cache_entry, &selected_queue, NULL, NULL, NULL);
