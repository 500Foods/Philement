...
void test_create_lookup_error_response_with_query_ref(void);
void test_create_lookup_error_response_with_message(void);
void test_create_lookup_error_response_all_fields(void);
...
void test_create_lookup_error_response_basic(void) {
    json_t* response = create_lookup_error_response("Test error", NULL, 0, false, NULL);
    ...
    TEST_ASSERT_NULL(json_object_get(response, "message"));
...
void test_create_lookup_error_response_with_database(void) {
    json_t* response = create_lookup_error_response("Test error", "mydb", 0, false, NULL);
...
void test_create_lookup_error_response_with_query_ref(void) {
    json_t* response = create_lookup_error_response("Test error", NULL, 123, true, NULL);
...
void test_create_lookup_error_response_with_message(void) {
    json_t* response = create_lookup_error_response("Test error", NULL, 0, false, "Test message");
    ...
    TEST_ASSERT_EQUAL_STRING("Test message", json_string_value(message));
...
void test_create_lookup_error_response_all_fields(void) {
    json_t* response = create_lookup_error_response("Test error", "mydb", 123, true, "Test message");
...
int main(void) {
    ...
    RUN_TEST(test_create_lookup_error_response_with_query_ref);
    RUN_TEST(test_create_lookup_error_response_with_message);
    RUN_TEST(test_create_lookup_error_response_all_fields);
