...
void test_build_success_response_basic_empty(void) {
    ...
    json_t* response = build_success_response(query_ref, (const QueryCacheEntry*)&cache_entry, (const QueryResult*)&result, (const DatabaseQueue*)&selected_queue, NULL, NULL);
