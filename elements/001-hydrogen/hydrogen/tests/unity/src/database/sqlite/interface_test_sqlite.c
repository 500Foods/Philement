/*
 * Unity Test File: SQLite Interface Functions
...
void test_sqlite_get_interface_not_null(void);
void test_sqlite_get_interface_valid_structure(void);
void test_sqlite_get_interface_function_pointers(void);
...
// Test sqlite_get_interface
void test_sqlite_get_interface_not_null(void) {
    DatabaseEngineInterface* interface = sqlite_get_interface();
...
void test_sqlite_get_interface_valid_structure(void) {
    DatabaseEngineInterface* interface = sqlite_get_interface();
    TEST_ASSERT_NOT_NULL(interface);
    TEST_ASSERT_EQUAL(DB_ENGINE_SQLITE, interface->engine_type);
    TEST_ASSERT_NOT_NULL(interface->name);
    TEST_ASSERT_EQUAL_STRING("sqlite", interface->name);
}
...
int main(void) {
    ...
    // Test sqlite_get_interface
    RUN_TEST(test_sqlite_get_interface_not_null);
    RUN_TEST(test_sqlite_get_interface_valid_structure);
    RUN_TEST(test_sqlite_get_interface_function_pointers);
