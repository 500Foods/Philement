...
void test_database_migrations_execute_transaction_null_sql(void) {
    bool result = database_migrations_execute_transaction(&test_connection, NULL, 10, "test.sql", DB_ENGINE_POSTGRESQL, "test");

    TEST_ASSERT_FALSE(result);
}

void test_database_migrations_execute_transaction_empty_sql(void) {
    bool result = database_migrations_execute_transaction(&test_connection, "", 0, "test.sql", DB_ENGINE_POSTGRESQL, "test");
...
void test_database_migrations_execute_transaction_parse_failure(void) {
    ...
    const char* sql = "SELECT 1;";
    bool result = database_migrations_execute_transaction(&test_connection, sql, strlen(sql), "test.sql", DB_ENGINE_POSTGRESQL, "test");
...
void test_database_migrations_execute_transaction_unsupported_engine(void) {
    const char* sql = "SELECT 1;";
    bool result = database_migrations_execute_transaction(&test_connection, sql, strlen(sql), "test.sql", DB_ENGINE_AI, "test");
