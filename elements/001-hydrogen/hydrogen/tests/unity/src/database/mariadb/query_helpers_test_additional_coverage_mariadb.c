/*
 * Unity Test File: MariaDB Query Helper Functions - Additional Coverage Tests
...
// MySQL type constants (from mariadb_com.h)
...
void test_mariadb_extract_column_names_strndup_failure(void);
void test_mariadb_build_json_from_result_calloc_failure(void);
void test_mariadb_build_json_from_result_realloc_failure_graceful(void);
void test_mariadb_build_json_from_result_string_escape_calloc_failure(void);
void test_mariadb_process_query_result_escaped_data_calloc_failure(void);
void test_mariadb_process_query_result_realloc_graceful(void);
void test_mariadb_process_prepared_result_buffer_allocation_failure(void);
void test_mariadb_process_prepared_result_col_buffer_allocation_failure(void);
void test_mariadb_process_prepared_result_bind_allocation_failure(void);
void test_mariadb_process_prepared_stmt_result_null_stmt(void);
void test_mariadb_process_prepared_stmt_result_success(void);
void test_mariadb_process_direct_result_null_result(void);
void test_mariadb_process_direct_result_success(void);
...
// ============================================================================
// Tests for mariadb_extract_column_names - additional coverage
// ============================================================================
...
// ============================================================================
// Tests for mariadb_build_json_from_result - additional coverage
// ============================================================================
...
void test_mariadb_build_json_from_result_calloc_failure(void) {
    ...
    bool success = mariadb_build_json_from_result(mariadb_result, 1, 1, NULL, &json_buffer);
...
void test_mariadb_build_json_from_result_string_escape_calloc_failure(void) {
    ...
    // Set string types
    mock_libmariadb_set_field_type(0, MYSQL_TYPE_LONG);
    mock_libmariadb_set_field_type(1, MYSQL_TYPE_STRING);
...
// ============================================================================
// Tests for mariadb_process_query_result - additional coverage
// ============================================================================
...
void test_mariadb_process_query_result_realloc_graceful(void) {
    ...
    // Set numeric types
    mock_libmariadb_set_field_type(0, MYSQL_TYPE_LONG);
    mock_libmariadb_set_field_type(1, MYSQL_TYPE_LONG);
...
// ============================================================================
// Tests for mariadb_process_prepared_result - additional coverage
// ============================================================================
...
void test_mariadb_process_prepared_result_buffer_allocation_failure(void) {
    ...
    QueryResult db_result = {0};
    bool success = mariadb_process_prepared_result(mariadb_result, &db_result, stmt_handle, "test");
...
// ============================================================================
// Tests for mariadb_process_prepared_stmt_result - additional coverage
// ============================================================================

void test_mariadb_process_prepared_stmt_result_null_stmt(void) {
    // Test null statement parameter
    // This covers early return in mariadb_process_prepared_stmt_result

    QueryResult result = {0};
    bool success = mariadb_process_prepared_stmt_result(NULL, &result, "test");
...
void test_mariadb_process_prepared_stmt_result_success(void) {
    ...
    // This covers the success path in mariadb_process_prepared_stmt_result
    ...
    QueryResult result = {0};
    bool success = mariadb_process_prepared_stmt_result(stmt, &result, "test");
    ...
    if (result.column_names) {
        mariadb_cleanup_column_names(result.column_names, result.column_count);
    }
    if (result.data_json) free(result.data_json);
}

// ============================================================================
// Tests for mariadb_process_direct_result - additional coverage
// ============================================================================

void test_mariadb_process_direct_result_null_result(void) {
    // Test null result parameter
    // This covers early return in mariadb_process_direct_result

    QueryResult result = {0};
    bool success = mariadb_process_direct_result((void*)0x12345, NULL, &result, "test");
...
void test_mariadb_process_direct_result_success(void) {
    ...
    // This covers the success path in mariadb_process_direct_result
    ...
    void* mariadb_conn = (void*)0x12345;
    void* mariadb_result = (void*)0x67890;
    QueryResult result = {0};
    bool success = mariadb_process_direct_result(mariadb_conn, mariadb_result, &result, "test");
...
int main(void) {
    ...
    // mariadb_extract_column_names additional tests
    RUN_TEST(test_mariadb_extract_column_names_strndup_failure);

    // mariadb_build_json_from_result additional tests
    RUN_TEST(test_mariadb_build_json_from_result_calloc_failure);
    RUN_TEST(test_mariadb_build_json_from_result_realloc_failure_graceful);
    RUN_TEST(test_mariadb_build_json_from_result_string_escape_calloc_failure);

    // mariadb_process_query_result additional tests
    RUN_TEST(test_mariadb_process_query_result_escaped_data_calloc_failure);
    RUN_TEST(test_mariadb_process_query_result_realloc_graceful);

    // mariadb_process_prepared_result additional tests
    RUN_TEST(test_mariadb_process_prepared_result_buffer_allocation_failure);
    RUN_TEST(test_mariadb_process_prepared_result_col_buffer_allocation_failure);
    RUN_TEST(test_mariadb_process_prepared_result_bind_allocation_failure);

    // mariadb_process_prepared_stmt_result additional tests
    RUN_TEST(test_mariadb_process_prepared_stmt_result_null_stmt);
    RUN_TEST(test_mariadb_process_prepared_stmt_result_success);

    // mariadb_process_direct_result additional tests
    RUN_TEST(test_mariadb_process_direct_result_null_result);
    RUN_TEST(test_mariadb_process_direct_result_success);
