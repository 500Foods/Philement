 ...
 * This file contains comprehensive unit tests for mariadb_execute_prepared function
...
void test_mariadb_execute_prepared_null_connection(void);
void test_mariadb_execute_prepared_null_stmt(void);
void test_mariadb_execute_prepared_null_request(void);
void test_mariadb_execute_prepared_null_result_ptr(void);
void test_mariadb_execute_prepared_wrong_engine_type(void);
void test_mariadb_execute_prepared_invalid_connection_handle(void);
void test_mariadb_execute_prepared_successful_execution_path(void);
void test_mariadb_execute_prepared_with_null_executable_sql(void);
...
void test_mariadb_execute_prepared_null_stmt(void) {
    ...
    bool success = mariadb_execute_prepared(connection, NULL, &request, &result);
...
void test_mariadb_execute_prepared_null_request(void) {
    ...
    bool success = mariadb_execute_prepared(connection, &stmt, NULL, &result);
...
void test_mariadb_execute_prepared_null_result_ptr(void) {
    ...
    bool success = mariadb_execute_prepared(connection, &stmt, &request, NULL);
...
int main(void) {
    ...
    // Parameter validation tests
    RUN_TEST(test_mariadb_execute_prepared_null_connection);
    RUN_TEST(test_mariadb_execute_prepared_null_stmt);
    RUN_TEST(test_mariadb_execute_prepared_null_request);
    RUN_TEST(test_mariadb_execute_prepared_null_result_ptr);
    RUN_TEST(test_mariadb_execute_prepared_wrong_engine_type);
    ...
    RUN_TEST(test_mariadb_execute_prepared_successful_execution_path);
    RUN_TEST(test_mariadb_execute_prepared_with_null_executable_sql);
