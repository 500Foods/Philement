/*
 * Unity Test File: MariaDB Query String Escaping Tests
...
void test_mariadb_execute_query_string_with_special_chars(void);
void test_mariadb_execute_query_null_column_name(void);
void test_mariadb_execute_query_large_data_reallocation(void);
...
void test_mariadb_execute_query_string_with_special_chars(void) {
    ...
    mock_libmariadb_set_mysql_num_rows_result(3);
    ...
    mock_libmariadb_setup_fields(1, col_names);
    mock_libmariadb_setup_result_data(3, 1, col_names, (char***)rows);
...
void test_mariadb_execute_query_null_column_name(void) {
    ...
    mock_libmariadb_setup_result_data(1, 2, col_names, (char***)rows);
...
void test_mariadb_execute_query_large_data_reallocation(void) {
    ...
    mock_libmariadb_setup_fields(1, col_names);
    mock_libmariadb_setup_result_data(1, 1, col_names, (char***)rows);
...
int main(void) {
    ...
    RUN_TEST(test_mariadb_execute_query_string_with_special_chars);
    
    // NULL column name fallback test
    RUN_TEST(test_mariadb_execute_query_null_column_name);
    
    // JSON buffer reallocation test
    RUN_TEST(test_mariadb_execute_query_large_data_reallocation);
