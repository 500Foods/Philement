 ...
 * Comprehensive tests for mariadb_prepare_statement function
 */
...
void test_mariadb_prepare_statement_null_mariadb_connection(void);
void test_mariadb_prepare_statement_null_mariadb_connection_field(void);
void test_mariadb_prepare_statement_no_function_pointers(void);
void test_mariadb_prepare_statement_mariadb_stmt_init_failure(void);
void test_mariadb_prepare_statement_mariadb_stmt_prepare_failure(void);
void test_mariadb_prepare_statement_timeout_scenario(void);
void test_mariadb_prepare_statement_memory_allocation_failure(void);
void test_mariadb_prepare_statement_custom_cache_size(void);
void test_mariadb_prepare_statement_lru_eviction(void);
void test_mariadb_prepare_statement_lru_eviction_cleanup(void);
void test_mariadb_prepare_statement_success_with_cache(void);
...
void test_mariadb_prepare_statement_null_mariadb_connection(void) {
    ...
    bool result = mariadb_prepare_statement(&connection, "test_stmt", "SELECT 1", &stmt, true);
...
// Test: mariadb_stmt_init failure
void test_mariadb_prepare_statement_mariadb_stmt_init_failure(void) {
    DatabaseHandle connection = {0};
    connection.engine_type = DB_ENGINE_MARIADB;
    ...
    // Mock mariadb_stmt_init to return NULL (failure)
...
// Test: mariadb_stmt_prepare failure
void test_mariadb_prepare_statement_mariadb_stmt_prepare_failure(void) {
    DatabaseHandle connection = {0};
    connection.engine_type = DB_ENGINE_MARIADB;
    ...
    // Mock mariadb_stmt_init to succeed
    mock_libmariadb_set_mysql_stmt_init_result((void*)0x5678);

    // Mock mariadb_stmt_prepare to fail (return non-zero)
...
void test_mariadb_prepare_statement_timeout_scenario(void) {
    ...
    // Mock mariadb_stmt_prepare to succeed but we'll simulate timeout
...
void test_mariadb_prepare_statement_memory_allocation_failure(void) {
    ...
    // Mock mariadb_stmt_prepare to succeed
    mock_libmariadb_set_mysql_stmt_prepare_result(0);
...
void test_mariadb_prepare_statement_lru_eviction(void) {
    ...
    TEST_ASSERT_TRUE(mariadb_prepare_statement(&connection, "stmt_2", "SELECT 2", &stmt2, true));
    ...
    TEST_ASSERT_TRUE(mariadb_prepare_statement(&connection, "stmt_3", "SELECT 3", &stmt3, true));
...
void test_mariadb_prepare_statement_success_with_cache(void) {
    ...
    PreparedStatement* stmt = NULL;
    bool result = mariadb_prepare_statement(&connection, "test_stmt", "SELECT * FROM users WHERE id = ?", &stmt, true);
...
int main(void) {
    ...
    RUN_TEST(test_mariadb_prepare_statement_null_mariadb_connection);
    RUN_TEST(test_mariadb_prepare_statement_null_mariadb_connection_field);
    RUN_TEST(test_mariadb_prepare_statement_no_function_pointers);
    RUN_TEST(test_mariadb_prepare_statement_mariadb_stmt_init_failure);
    RUN_TEST(test_mariadb_prepare_statement_mariadb_stmt_prepare_failure);
    RUN_TEST(test_mariadb_prepare_statement_timeout_scenario);
    RUN_TEST(test_mariadb_prepare_statement_memory_allocation_failure);
    RUN_TEST(test_mariadb_prepare_statement_custom_cache_size);
    RUN_TEST(test_mariadb_prepare_statement_lru_eviction);
    RUN_TEST(test_mariadb_prepare_statement_lru_eviction_cleanup);
    RUN_TEST(test_mariadb_prepare_statement_success_with_cache);
