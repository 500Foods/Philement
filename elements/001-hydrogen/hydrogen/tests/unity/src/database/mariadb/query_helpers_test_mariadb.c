 ...
 * Tests for mariadb_extract_column_names, mariadb_build_json_from_result,
 * mariadb_cleanup_column_names, mariadb_calculate_json_buffer_size,
 * mariadb_validate_query_parameters, mariadb_execute_query_statement,
 * mariadb_store_query_result, mariadb_process_query_result, mariadb_process_prepared_result
 */
...
void test_mariadb_extract_column_names_zero_count(void);
void test_mariadb_extract_column_names_null_fields(void);
void test_mariadb_extract_column_names_with_null_field_name(void);
...
void test_mariadb_build_json_from_result_null_buffer_ptr(void);
void test_mariadb_build_json_from_result_with_data(void);
void test_mariadb_build_json_from_result_with_null_values(void);
void test_mariadb_cleanup_column_names_null(void);
void test_mariadb_cleanup_column_names_valid(void);
...
void test_mariadb_calculate_json_buffer_size_large(void);
...
void test_mariadb_validate_query_parameters_valid(void);
void test_mariadb_execute_query_statement_success(void);
void test_mariadb_execute_query_statement_failure(void);
void test_mariadb_execute_query_statement_failure_with_error(void);
void test_mariadb_execute_query_statement_failure_with_empty_error(void);
void test_mariadb_store_query_result_success(void);
void test_mariadb_store_query_result_null(void);
void test_mariadb_process_query_result_null_result(void);
void test_mariadb_process_query_result_empty_result(void);
void test_mariadb_process_query_result_with_null_column_value(void);
void test_mariadb_process_query_result_with_null_field_name(void);
void test_mariadb_process_prepared_result_no_result_set(void);
...
void test_mariadb_extract_column_names_null_result(void) {
    char** result = mariadb_extract_column_names(NULL, 3);
    TEST_ASSERT_NULL(result);
}

void test_mariadb_extract_column_names_zero_count(void) {
    void* mariadb_result = (void*)0x12345;
    char** result = mariadb_extract_column_names(mariadb_result, 0);
    TEST_ASSERT_NULL(result);
}
...
void test_mariadb_extract_column_names_null_fields(void) {
    ...
    // inside the function when it calls mariadb_fetch_fields_ptr(mariadb_result).
    // This test is simplified to just verify the function doesn't crash with edge cases.
    mock_libmariadb_set_mysql_fetch_fields_result(NULL);
    
    char** result = mariadb_extract_column_names(mariadb_result, 2);
    // The mock may not properly simulate NULL return, so we just verify no crash
    if (result) {
        mariadb_cleanup_column_names(result, 2);
    }
...
void test_mariadb_extract_column_names_with_null_field_name(void) {
    ...
    char** result = mariadb_extract_column_names(mariadb_result, 3);
...
void test_mariadb_build_json_from_result_null_result(void) {
    ...
    bool success = mariadb_build_json_from_result(NULL, 1, 1, NULL, &json_buffer);
...
void test_mariadb_build_json_from_result_zero_rows(void) {
    void* mariadb_result = (void*)0x12345;
    char* json_buffer = NULL;
    bool success = mariadb_build_json_from_result(mariadb_result, 0, 2, NULL, &json_buffer);
...
void test_mariadb_build_json_from_result_zero_columns(void) {
    void* mariadb_result = (void*)0x12345;
    char* json_buffer = NULL;
    bool success = mariadb_build_json_from_result(mariadb_result, 2, 0, NULL, &json_buffer);
...
void test_mariadb_build_json_from_result_null_buffer_ptr(void) {
    void* mariadb_result = (void*)0x12345;
    bool success = mariadb_build_json_from_result(mariadb_result, 1, 1, NULL, NULL);
...
void test_mariadb_build_json_from_result_with_data(void) {
    ...
    char* json_buffer = NULL;
    bool success = mariadb_build_json_from_result(mariadb_result, 2, 2, col_names_copy, &json_buffer);
...
void test_mariadb_build_json_from_result_with_null_values(void) {
    ...
    char* json_buffer = NULL;
    bool success = mariadb_build_json_from_result(mariadb_result, 1, 2, col_names_copy, &json_buffer);
...
void test_mariadb_cleanup_column_names_valid(void) {
    ...
    mariadb_cleanup_column_names(column_names, 3);
...
void test_mariadb_calculate_json_buffer_size_zero_rows(void) {
    size_t size = mariadb_calculate_json_buffer_size(0, 5);
    TEST_ASSERT_EQUAL(0, size);
}

void test_mariadb_calculate_json_buffer_size_multiple_rows(void) {
    size_t size = mariadb_calculate_json_buffer_size(10, 5);
    TEST_ASSERT_EQUAL(10 * 1024, size);
}

void test_mariadb_calculate_json_buffer_size_large(void) {
    size_t size = mariadb_calculate_json_buffer_size(1000, 20);
...
void test_mariadb_validate_query_parameters_null_connection(void) {
    ...
    bool valid = mariadb_validate_query_parameters(NULL, &request, &result);
...
void test_mariadb_validate_query_parameters_null_request(void) {
    ...
    bool valid = mariadb_validate_query_parameters(&connection, NULL, &result);
    TEST_ASSERT_FALSE(valid);
}
...
void test_mariadb_validate_query_parameters_null_result(void) {
    ...
    bool valid = mariadb_validate_query_parameters(&connection, &request, NULL);
    TEST_ASSERT_FALSE(valid);
}
...
void test_mariadb_validate_query_parameters_wrong_engine(void) {
    ...
    bool valid = mariadb_validate_query_parameters(&connection, &request, &result);
    TEST_ASSERT_FALSE(valid);
}
...
void test_mariadb_execute_query_statement_success(void) {
    void* mariadb_connection = (void*)0x12345;
    
    // Mock successful query
    mock_libmariadb_set_mysql_query_result(0);
    
    bool success = mariadb_execute_query_statement(mariadb_connection, "SELECT 1", "test");
    TEST_ASSERT_TRUE(success);
}
...
void test_mariadb_execute_query_statement_failure(void) {
    ...
    bool success = mariadb_execute_query_statement(mariadb_connection, "SELECT * FROM invalid", "test");
    TEST_ASSERT_FALSE(success);
}
...
void test_mariadb_execute_query_statement_failure_with_error(void) {
    ...
    mock_libmariadb_set_mysql_query_result(1);
    mock_libmariadb_set_mysql_error_result("Table doesn't exist");
...
void test_mariadb_store_query_result_success(void) {
    ...
    mock_libmariadb_set_mysql_store_result_result(expected_result);
    
    void* result = mariadb_store_query_result(mariadb_connection, "test");
...
void test_mariadb_process_query_result_null_result(void) {
    ...
    bool success = mariadb_process_query_result(NULL, &db_result, "test");
...
void test_mariadb_process_query_result_empty_result(void) {
    ...
    mock_libmariadb_set_mysql_num_rows_result(0);
    mock_libmariadb_set_mysql_num_fields_result(2);
    
    const char* column_names[] = {"id", "name"};
    mock_libmariadb_setup_fields(2, column_names);
    
    bool success = mariadb_process_query_result(mariadb_result, &db_result, "test");
...
void test_mariadb_process_query_result_with_null_column_value(void) {
    ...
    mock_libmariadb_set_mysql_num_rows_result(1);
    mock_libmariadb_set_mysql_num_fields_result(2);
...
void test_mariadb_process_prepared_result_no_result_set(void) {
    ...
    mock_libmariadb_set_mysql_affected_rows_result(5);
    
    bool success = mariadb_process_prepared_result(NULL, &db_result, stmt_handle, "test");
...
// Note: Tests for mariadb_process_prepared_result with field names would require
// additional mock functions that aren't currently available in mock_libmariadb
// (mariadb_stmt_field_count, mariadb_stmt_fetch, etc.). The basic functionality
...
int main(void) {
    ...
    RUN_TEST(test_mariadb_extract_column_names_zero_count);
    RUN_TEST(test_mariadb_extract_column_names_null_fields);
    RUN_TEST(test_mariadb_extract_column_names_with_null_field_name);
    ...
    RUN_TEST(test_mariadb_build_json_from_result_null_buffer_ptr);
    RUN_TEST(test_mariadb_build_json_from_result_with_data);
    RUN_TEST(test_mariadb_build_json_from_result_with_null_values);
    
    // mariadb_cleanup_column_names tests
    RUN_TEST(test_mariadb_cleanup_column_names_null);
    RUN_TEST(test_mariadb_cleanup_column_names_valid);
    ...
    RUN_TEST(test_mariadb_calculate_json_buffer_size_large);
    ...
    RUN_TEST(test_mariadb_validate_query_parameters_valid);
    ...
    RUN_TEST(test_mariadb_execute_query_statement_failure_with_error);
    RUN_TEST(test_mariadb_execute_query_statement_failure_with_empty_error);
    
    // mariadb_store_query_result tests
    RUN_TEST(test_mariadb_store_query_result_success);
    RUN_TEST(test_mariadb_store_query_result_null);
    
    // mariadb_process_query_result tests
    RUN_TEST(test_mariadb_process_query_result_null_result);
    RUN_TEST(test_mariadb_process_query_result_empty_result);
    RUN_TEST(test_mariadb_process_query_result_with_null_column_value);
    RUN_TEST(test_mariadb_process_query_result_with_null_field_name);
    
    // mariadb_process_prepared_result tests
    RUN_TEST(test_mariadb_process_prepared_result_no_result_set);
