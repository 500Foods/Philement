...
#ifndef MOCK_LIBMARIADB_H
#define MOCK_LIBMARIADB_H
...
// Mock function declarations - these will override the real ones when USE_MOCK_LIBMARIADB is defined
...
void mock_libmariadb_set_mysql_stmt_store_result_result(int result); // PERSIST_PLAN Phase 1b
...
#endif // USE_MOCK_LIBMARIADB

#endif // MOCK_LIBMARIADB_H
