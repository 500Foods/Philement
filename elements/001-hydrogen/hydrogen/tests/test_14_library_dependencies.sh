...
# CHANGELOG
# 4.1.2 - 2026-07-28 - Added checks for MagickWand (ImageMagick) and zlib dependencies
...
check_dependency_log "MagickWand" "${LOG_FILE}"
check_dependency_log "zlib" "${LOG_FILE}"
