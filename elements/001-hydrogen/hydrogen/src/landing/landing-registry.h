 ...
 * @brief Subsystem Registry landing (shutdown) readiness checks and cleanup
 *
...
/**
 * @brief Check if the Subsystem Registry is ready to land
...
/**
 * @brief Free resources allocated by the Subsystem Registry
 * 
