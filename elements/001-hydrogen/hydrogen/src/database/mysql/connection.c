...
mysql_num_rows_t mysql_num_rows_ptr = mock_mysql_num_rows;
mysql_num_fields_t mysql_num_fields_ptr = mock_mysql_num_fields;
mysql_fetch_row_t mysql_fetch_row_ptr = mock_mysql_fetch_row;
mysql_fetch_fields_t mysql_fetch_fields_ptr = mock_mysql_fetch_fields;
...
mysql_affected_rows_t mysql_affected_rows_ptr = mock_mysql_affected_rows;
mysql_stmt_init_t mysql_stmt_init_ptr = mock_mysql_stmt_init;
mysql_stmt_prepare_t mysql_stmt_prepare_ptr = mock_mysql_stmt_prepare;
mysql_stmt_execute_t mysql_stmt_execute_ptr = mock_mysql_stmt_execute;
mysql_stmt_close_t mysql_stmt_close_ptr = mock_mysql_stmt_close;
mysql_stmt_result_metadata_t mysql_stmt_result_metadata_ptr = mock_mysql_stmt_result_metadata;
mysql_stmt_fetch_t mysql_stmt_fetch_ptr = mock_mysql_stmt_fetch;
mysql_stmt_bind_param_t mysql_stmt_bind_param_ptr = mock_mysql_stmt_bind_param;
mysql_stmt_bind_result_t mysql_stmt_bind_result_ptr = mock_mysql_stmt_bind_result;
mysql_stmt_error_t mysql_stmt_error_ptr = mock_mysql_stmt_error;
mysql_stmt_affected_rows_t mysql_stmt_affected_rows_ptr = mock_mysql_stmt_affected_rows;
...
mysql_stmt_bind_param_t mysql_stmt_bind_param_ptr = NULL;
...
#pragma GCC diagnostic ignored "-Wpedantic"
    ...
    mysql_stmt_bind_param_ptr = (mysql_stmt_bind_param_t)dlsym(libmysql_handle, "mysql_stmt_bind_param");
