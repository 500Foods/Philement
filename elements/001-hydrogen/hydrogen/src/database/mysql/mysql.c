...
static const char* mysql_engine_get_version(void) {
    return "MySQL Engine v1.0.0";
}

static bool mysql_engine_is_available(void) {
...
static const char* mysql_engine_get_description(void) {
...
__attribute__((unused)) static void mysql_engine_test_functions(void) {
