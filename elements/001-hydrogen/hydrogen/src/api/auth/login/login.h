...
//@ swagger:requestBody application/json {"type":"object","required":["login_id","password","api_key","tz"],"properties":{"login_id":{"type":"string","minLength":1,"maxLength":255,"description":"Username or email address for authentication"},"password":{"type":"string","minLength":8,"maxLength":128,"description":"User password"},"api_key":{"type":"string","minLength":1,"maxLength":255,"description":"API key for application identification"},"tz":{"type":"string","minLength":1,"maxLength":50,"description":"Client timezone (e.g., 'America/Vancouver')"}}}
