/*
 * Reporting image_scale API Endpoint (swagger surface)
 *
 * Thin header under src/api/reporting/ so swagger-generate.sh discovers
 * the endpoint. Implementation remains in src/reporting/image_scale/.
 */

#ifndef HYDROGEN_API_REPORTING_IMAGE_SCALE_H
#define HYDROGEN_API_REPORTING_IMAGE_SCALE_H
...
/* Prototype for swagger-generate discovery; impl in src/reporting/image_scale/. */
...
#endif /* HYDROGEN_API_REPORTING_IMAGE_SCALE_H */
