...
//@ swagger:request body application/json {"type":"object","required":["database","queries"],"properties":{"database":{"type":"string","description":"Target database name (required)","example":"Demo_PG"},"queries":{"type":"array","description":"Array of queries to execute in parallel (required)","items":{"type":"object","required":["query_ref"],"properties":{"query_ref":{"type":"integer","description":"Query identifier from Query Table Cache (required)","example":53},"params":{"type":"object","description":"Typed parameters for query execution (optional)","properties":{"INTEGER":{"type":"object","description":"Integer parameters as key-value pairs","example":{"START":10,"FINISH":20}},"STRING":{"type":"object","description":"String parameters as key-value pairs","example":{"username":"johndoe","email":"john@example.com"}},"BOOLEAN":{"type":"object","description":"Boolean parameters as key-value pairs","example":{"isActive":true,"requireAuth":false}},"FLOAT":{"type":"object","description":"Float parameters as key-value pairs","example":{"discount":0.15,"tax":0.07}}}}}}},"example":{"database":"Demo_PG","queries":[{"query_ref":53,"params":{}},{"query_ref":55,"params":{"INTEGER":{"START":10,"FINISH":20}}}]}}}
