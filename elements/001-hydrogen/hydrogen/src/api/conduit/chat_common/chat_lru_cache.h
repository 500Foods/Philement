...
#ifndef CHAT_LRU_CACHE_H
#define CHAT_LRU_CACHE_H
...
#define CHAT_LRU_CACHE_MAX_SIZE_BYTES     (1024ULL * 1024ULL * 1024ULL)  /* 1GB */
#define CHAT_LRU_CACHE_DIR_NAME           "cache"       /* Relative to cwd */
#define CHAT_LRU_CACHE_METADATA_FILE      "cache_metadata.json"
#define CHAT_LRU_CACHE_MAX_HASH_LEN       64
#define CHAT_LRU_CACHE_PREFIX_LEN         2   /* First 2 chars for directory */
#define CHAT_LRU_CACHE_SYNC_INTERVAL_SEC  60  /* Background sync interval */
#define CHAT_CACHE_DIR_ENV_VAR            "CHAT_CACHE_DIR"  /* Override cache dir */

/* Hash table size - power of 2 for fast modulo */
#define CHAT_LRU_CACHE_HASH_TABLE_SIZE    4096

/* LRU Cache entry */
typedef struct ChatLRUCacheEntry {
    char hash[CHAT_LRU_CACHE_MAX_HASH_LEN];     /* Segment hash (key) */
