...
#define MAX_MAIL_RELAY_ALLOW_SENDERS 50
#define MAX_MAIL_RELAY_BLOCK_SENDERS 50
#define MAX_MAIL_RELAY_RATE_LIMIT_KEYS 256

// Mail relay API rate-limit scope modes
#define MAIL_RL_SCOPE_GLOBAL 0
#define MAIL_RL_SCOPE_USER 1
#define MAIL_RL_SCOPE_IP 2
#define MAIL_RL_SCOPE_TEMPLATE 3

#define MIN_MAIL_RL_REQUESTS 0
#define MAX_MAIL_RL_REQUESTS 100000
#define MIN_MAIL_RL_INTERVAL 1
#define MAX_MAIL_RL_INTERVAL 86400
