...
ReadinessResults handle_readiness_checks(void) {
    ...
    process_subsystem_readiness(&results, &index, SR_REPORTING, check_reporting_launch_readiness());
    process_subsystem_readiness(&results, &index, SR_MCP, check_mcp_launch_readiness());
