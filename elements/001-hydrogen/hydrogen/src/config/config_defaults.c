...
bool initialize_config_defaults(AppConfig* config) {
    ...
    log_this(SR_CONFIG, "Successfully initialized configuration defaults", LOG_LEVEL_STATE, 0);
    return true;
}
...
void initialize_config_defaults_server(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Server", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_network(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Network", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_database(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Database (no default connections)", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_logging(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Logging", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_webserver(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Webserver", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_api(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for API", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_swagger(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Swagger", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_websocket(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Websockets", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_terminal(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Terminal", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_mdns_server(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for mDNS Server", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_mdns_client(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for mDNS Client", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_mail_relay(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Mail Relay", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_print(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Print", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_resources(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Resources", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_oidc(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for OIDC", LOG_LEVEL_STATE, 0);
    }
}
...
void initialize_config_defaults_notify(AppConfig* config) {
    if (config) {
        ...
        log_this(SR_CONFIG, "Applied config defaults for Notify", LOG_LEVEL_STATE, 0);
    }
}
