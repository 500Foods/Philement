-- Migration: acuranzo_1083.lua
-- Defaults for Lookup 050 - Document Status
...
cfg.MIGRATION = "1083"
cfg.LOOKUP_ID = "050"
cfg.LOOKUP_NAME = "Document Status"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Typically active/inactive but likely to include other types in future.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
