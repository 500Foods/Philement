-- Migration: acuranzo_1036.lua
-- Defaults for Lookup 011 - Workflow Step Status
...
cfg.MIGRATION = "1036"
cfg.LOOKUP_ID = "011"
cfg.LOOKUP_NAME = "Workflow Step Status"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Categorizes workflow step status.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'Informational',   0, 0, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Active',          0, 1, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 2, 1, 'Mandatory',       0, 2, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 3, 1, 'Optional',        0, 3, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 4, 1, 'Deprecated',      0, 4, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 5, 1, 'Obsolete',        0, 5, '', '', '{}', ${COMMON_VALUES});
