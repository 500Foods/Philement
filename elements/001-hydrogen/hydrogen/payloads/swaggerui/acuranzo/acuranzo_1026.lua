...
-- Defaults for Lookup 001 - Lookup Status
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                ...
                (${LOOKUP_ID}, 2, 1, 'Deprecated',  0, 2, '', '', ${JIS}[==[{"icon":"<fa fa-minus fa-swap-opacity style='color: #FFFF00; filter: var(--ACZ-shadow-4);'></fa>"}]==]${JIE}, ${COMMON_VALUES});
