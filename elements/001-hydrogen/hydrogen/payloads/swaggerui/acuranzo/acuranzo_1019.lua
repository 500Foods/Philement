...
-- 1.0.0 - 2025-09-13 - Initial creation for systems table with PostgreSQL support.
    ...
    SELECT
        ...
        [=[
            ...
            (
                ...
                status_a14              ${INTEGER}          NOT NULL,
                access_type_a15         ${INTEGER}          NOT NULL,
                name                    ${TEXT}             NOT NULL,
                summary                 ${TEXT_BIG}                 ,
                collection              ${JSON}                     ,
                ${PRIMARY}(system_id)
        ...
        [=[
            ...
            This migration creates the ${TABLE} table for storing system data.
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
        ${COMMON_INSERT}
