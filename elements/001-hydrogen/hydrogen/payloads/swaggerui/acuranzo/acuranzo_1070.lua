...
-- CHANGELOG
-- 1.0.0 - 2025-12-16 - Initial creation
                ...
                (${LOOKUP_ID},  ${THEME_ID}, 1, '${THEME_NAME}', 0, 0, [==[
                    ...
                    */
                    ...
                    .Theme-Mustafar {
                        ...
                        --ACZ-color-0:  rgba(  15,   0,   0, 0.50);     /* highlighting */
                        --ACZ-color-1:  rgba(  80,   0,   0, 0.25);     /* highlighting */
                        --ACZ-color-2:  rgba(  96,   0,   0, 0.50);     /* btn-primary */
                        --ACZ-color-3:  rgba(  96,   0,   0, 1.00);     /* btn-primary :hover */
                        --ACZ-color-4:  rgba( 192,   0,   0, 0.50);     /* btn-secondary */
                        --ACZ-color-5:  rgba(  64,   0,   0, 1.00);     /* btn-secondary :hover */
                        --ACZ-color-6:  rgba(  96,   0,   0, 1.00);     /* btn-dark */
                        --ACZ-color-7:  rgba(  96,   0,   0, 1.00);     /* btn-dark :hover */
                        --ACZ-color-8:  gold;                           /* btn-warning */
                        --ACZ-color-9:  orange;                         /* btn-warning :hover */
                        --ACZ-color-10: rgba( 223, 191, 191, 0.50);     /* btn-info */
                        --ACZ-color-11: rgba( 223, 191, 191, 1.00);     /* btn-info :hover */
                        --ACZ-color-12: rgba( 255,   0,   0, 0.10);     /* zebra stripe rows */
                        --ACZ-color-13: rgba( 255, 128, 128, 0.25);     /* tabulator cell hover */
                        --ACZ-color-14: rgba(   0,   0,   0, 1.00);     /* chat <pre> background, chat system text */
                        --ACZ-color-15: rgba(  63,   0,   0, 0.50);
                        --ACZ-color-16: rgba(  63,   0,   0, 1.00);
                        --ACZ-color-17: rgba( 128,  48,  48, 1.00);     /* scrollbar track */
                        ...
                        */
                        --ACZ-progress-color-1: var(--ACZ-color-8 ); /* active dot     */
                        --ACZ-progress-color-2: var(--ACZ-color-6 ); /* active rings   */
                        --ACZ-progress-color-3: var(--ACZ-color-8 ); /* inactive dot   */
                        --ACZ-progress-color-4: var(--ACZ-color-6 ); /* inactive rings */

                        --ACZ-progress-opacity-1: 1.0;
                        --ACZ-progress-opacity-2: 1.0;
                        --ACZ-progress-opacity-3: 0.1;
                        --ACZ-progress-opacity-4: 0.6;
