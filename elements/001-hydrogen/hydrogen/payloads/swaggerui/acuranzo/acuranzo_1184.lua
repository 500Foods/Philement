-- Migration: acuranzo_1184.lua
-- LithiumTable lookups-manager-values (lookup_id 059, key_idx 7)
...
cfg.LOOKUP_ID = "059"
cfg.KEY_IDX = "7"
cfg.TABLEDEF_NAME = "lookups-manager-values"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                ...
                [==[
                    # Lookups Mnaager Values tableDef
