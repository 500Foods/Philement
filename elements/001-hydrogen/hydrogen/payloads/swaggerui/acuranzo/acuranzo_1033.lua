        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Categorizes note status like published, deprecated, etc.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'Private',     0, 0, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Published',   0, 1, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 2, 1, 'Deprecated',  0, 2, '', '', '{}', ${COMMON_VALUES}),
                (${LOOKUP_ID}, 3, 1, 'Obsolete',    0, 3, '', '', '{}', ${COMMON_VALUES});
