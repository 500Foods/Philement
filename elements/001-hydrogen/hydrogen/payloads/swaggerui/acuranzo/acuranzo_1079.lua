-- Migration: acuranzo_1079.lua
-- Defaults for Lookup 046 - Macro Expansion

-- luacheck: no max line length
-- luacheck: no unused args

-- CHANGELOG
-- 1.0.0 - 2025-12-24 - Initial creation
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Macro expansion. These are generally used in documentation but could be used
                    elsewhere in future. Note this is different than Translations.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID},  0, 1, '{ACZ.CLIENT}', 0, 0, '', '', ${JIS}[==[{"en-US": "Acuranzo Web Client App", "Default": "Acuranzo Web Client App"}]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID},  1, 1, '{ACZ.SERVER}', 0, 0, '', '', ${JIS}[==[{"en-US": "Acuranzo Server", "Default": "Acuranzo Server"}]==]${JIE}, ${COMMON_VALUES});
