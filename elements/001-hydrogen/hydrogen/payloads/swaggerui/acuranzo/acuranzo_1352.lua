-- Migration: acuranzo_1352.lua
-- PRIORITIZE 2.35: Enroll.PaidCourse fail-closed on retired
--
-- Do not restamp 1329.
--
...
--
-- CHANGELOG
-- 1.0.0 - 2026-08-21 - PaidCourse not_offered when retired (PRIORITIZE 2.35)
...
return M
            ...
            WHERE query_ref = ${MIGRATION}
              and query_type_a28 = ${TYPE_FORWARD_MIGRATION};
                                                                            ...
                                                                            AS code,
        'PaidCourse fail-closed on retired' AS name,
        [=[
            # Forward Migration ${MIGRATION}: PaidCourse fail-closed on retired=1 (do not restamp 1329)
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
        ${COMMON_INSERT}
...
return M
            ...
            WHERE query_ref = ${MIGRATION}
              and query_type_a28 = ${TYPE_APPLIED_MIGRATION};
                                                                            ...
                                                                            AS code,
        'Restore Enroll.PaidCourse without retired check' AS name,
        [=[
            # Reverse Migration ${MIGRATION}: Restore prior Enroll.PaidCourse
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
        ${COMMON_INSERT}
