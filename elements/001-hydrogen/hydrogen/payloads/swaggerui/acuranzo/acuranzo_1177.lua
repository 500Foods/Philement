-- Migration: acuranzo_1177.lua
-- QueryRef #074 - Update Account Settings
...
cfg.MIGRATION = "1177"
cfg.QUERY_REF = "074"
cfg.QUERY_NAME = "Update Account Settings"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
        ...
        [=[
            ...
            SELECT
                ...
                [==[
                    ...
                    Updates the account settings for a specific account and client.
