        ...
        [=[
            ...
            VALUES
                (${LOOKUP_ID},  ${THEME_ID}, 1, '${THEME_NAME}', 0, 0, [==[
                    ...
                    */
                    ...
                    .Theme-Lanboss {
                        ...
                        */
                        ...
                        --ACZ-color-1:  rgba( 254, 232, 214, 1.00);     /* main panel bg */
                        --ACZ-color-2:  rgba( 254, 157,  66, 1.00);     /* btn-primary */
                        --ACZ-color-3:  rgba( 224, 127,  25, 1.00);     /* btn-primary:hover */
                        --ACZ-color-4:  rgba( 254, 157,  66, 0.50);     /* btn-secondary */
                        --ACZ-color-5:  rgba( 224, 127,  25, 1.00);     /* btn-secondary:hover */
                        --ACZ-color-6:  rgba( 224, 127,  25, 1.00);     /* btn-dark tt-border */
                        --ACZ-color-7:  rgba( 224, 127,  25, 0.50);     /* btn-dark:hover tt-text */
                        ...
                        --ACZ-color-11: rgba(   0,   0,   0, 0.80);     /* btn-info:hover tt-bg */
                        --ACZ-color-12: rgba(   0,   0,   0, 0.10);     /* tb-zebra-stripes */
                        --ACZ-color-13: rgba( 128, 128, 255, 0.25);     /* tb-cell:hover */
                        --ACZ-color-14: rgba(   0,   0,   0, 1.00);     /* chat <pre> background, chat system text */
                        --ACZ-color-15: rgba( 224, 127,  25, 1.00);
                        ...
                        */
                        ...
                        --ACZ-tooltips-background: var(--ACZ-color-1);
                        ...
                        */
                        ...
                        --ACZ-shadow-4: drop-shadow( 1px  0px 0px var(--ACZ-color-3))
                                        drop-shadow( 0px  1px 0px var(--ACZ-color-3))
                                        drop-shadow(-1px  0px 0px var(--ACZ-color-3))
                                        drop-shadow( 0px -1px 0px var(--ACZ-color-3));
                    ...
                    */
                    .Theme-Lanboss body {
                        background-color: rgba( 254, 232, 214, 1.00);
                    }
                ]==], '', '{}', ${COMMON_VALUES});
