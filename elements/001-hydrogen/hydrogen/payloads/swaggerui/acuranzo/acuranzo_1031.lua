...
cfg.MIGRATION = "1031"
cfg.LOOKUP_ID = "006"
cfg.LOOKUP_NAME = "Connection Status"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Categorizes connection status as enabled or disabled.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'Disabled',    0, 0, '', '', ${JIS}[==[{"Icon":"<i class='fa fa-xmark fa-fw fa-swap-opacity' style='color: #FF0000; filter: var(--ACZ-shadow-4);'></i>"}]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Enabled',     0, 1, '', '', ${JIS}[==[{"Icon":"<i class='fa fa-check fa-fw fa-swap-opacity' style='color: #00FF00; filter: var(--ACZ-shadow-4);'></i>"}]==]${JIE}, ${COMMON_VALUES});
