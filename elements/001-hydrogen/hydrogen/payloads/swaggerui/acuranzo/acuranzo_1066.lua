-- Migration: acuranzo_1066.lua
-- Defaults for Lookup 041 - Themes
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Themes. The individual themes are supplied in subsequent migrations, this one
                    is just for managing the lookup entry.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
