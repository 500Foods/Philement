        ...
        [=[
            ...
            SELECT
                ...
                [==[
                    ...
                    This query stores a chat conversation.
                    ...
                    - Affected rows in the `convos` table where the new chat entry was inserted. Expected to be 1.
