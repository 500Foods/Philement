-- Migration: acuranzo_1247.lua
-- QueryRef #117 - Get OTP by ID
...
cfg.MIGRATION = "1247"
cfg.QUERY_REF = "117"
cfg.QUERY_NAME = "Get OTP by ID"
-- ----------------------------------------------------------------------------
-- Forward: Populate QueryRef #117 - Get OTP by ID
-- ----------------------------------------------------------------------------
table.insert(queries,{sql=[[
    ...
    SELECT
        ...
        [=[
            ...
            SELECT
                ...
                [==[
                    ...
                    Retrieves a single OTP row by its primary key.

                    ## Parameters

                    - `OTP_ID` (integer, required): OTP primary key.
        ...
        [=[
            ...
            OTP row by ID (QueryRef #${QUERY_REF}).
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
        ${COMMON_INSERT}
...
-- ----------------------------------------------------------------------------
-- Reverse: Remove QueryRef #117 - Get OTP by ID
-- ----------------------------------------------------------------------------
table.insert(queries,{sql=[[
