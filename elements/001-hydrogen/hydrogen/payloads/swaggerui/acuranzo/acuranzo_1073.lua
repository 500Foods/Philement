...
-- CHANGELOG
-- 1.0.0 - 2025-12-18 - Initial creation
                    ...
                    */
                    ...
                    .Theme-Bland {
                        ...
                        */
                        ...
                        --ACZ-color-0:  rgba(  47,  47,  47, 0.50);     /* highlighting */
                        --ACZ-color-1:  rgba(  47,  47,  47, 0.00);     /* main panel bg */
                        --ACZ-color-2:  rgba(  15,  15,  15, 0.00);     /* btn-primary */
                        --ACZ-color-3:  rgba(  15,  15,  15, 0.00);     /* btn-primary:hover */
                        --ACZ-color-4:  rgba( 191, 191, 191, 0.00);     /* btn-secondary, scroll thumbs */
                        --ACZ-color-5:  rgba(   0,   0, 127, 0.00);     /* btn-secondary:hover */
                        --ACZ-color-6:  rgba(   0,   0, 175, 0.00);     /* btn-dark tt-border */
                        --ACZ-color-7:  rgba(   0,   0,  87, 0.00);     /* btn-dark:hover tt-text */
                        ...
                        --ACZ-color-11: rgba( 191, 191, 191, 1.00);     /* btn-info:hover tt-bg */
                        --ACZ-color-12: rgba(   0,   0, 255, 0.00);     /* tb-zebra-stripes */
                        --ACZ-color-13: rgba( 128, 128, 128, 0.25);     /* tb-cell:hover */
                        --ACZ-color-14: rgba(   0,   0,   0, 1.00);     /* chat <pre> background, chat system text */
                        --ACZ-color-15: rgba(   0,   0,  63, 0.00);
                        --ACZ-color-16: rgba(  15,  15,  15, 1.00);     /* tb-nav-text-disabled */
                        --ACZ-color-17: rgba(  96,  96,  96, 1.00);     /* scrollbar track */
                        --ACZ-color-18: rgba( 255, 255,   0, 0.70);     /* PDF crop rectangle */
                        --ACZ-color-19: rgba( 239, 239, 239, 1.00);     /* tb-cell-selected */
                        ...
                        */
                        ...
                        --ACZ-border-4: 1px solid transparent;
                        ...
                        */
                        --ACZ-tooltips-text: white;
                        --ACZ-tooltips-background: #222222;
