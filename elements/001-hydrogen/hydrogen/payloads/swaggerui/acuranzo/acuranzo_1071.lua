...
-- CHANGELOG
-- 1.0.0 - 2025-12-17 - Initial creation
                    ...
                    */
                    ...
                    .Theme-1977 {
                        ...
                        */
                        ...
                        --ACZ-color-0:  rgba(  31,  31, 31,  0.25);     /* highlighting */
                        --ACZ-color-1:  rgba(  63,  63, 127, 0.25);     /* highlighting */
                        --ACZ-color-2:  rgba( 115,  15, 115, 0.50);     /* btn-primary */
                        --ACZ-color-3:  rgba(  15,  15, 191, 0.25);     /* btn-primary:hover */
                        --ACZ-color-4:  rgba(   0,   0, 127, 0.50);     /* btn-secondary */
                        --ACZ-color-5:  rgba( 255,  64,   0, 1.00);     /* btn-secondary:hover */
                        --ACZ-color-6:  rgba( 255,  64,   0, 1.00);     /* btn-dark */
                        --ACZ-color-7:  rgba( 255, 255,   0, 1.00);     /* btn-dark:hover */
                        --ACZ-color-8:  rgba( 255, 255,   0, 1.00);     /* btn-warning */
                        --ACZ-color-9:  rgba( 255, 215,   0, 1.00);     /* btn-warning:hover */
                        --ACZ-color-10: rgba( 223, 223, 255, 0.50);     /* btn-info */
                        --ACZ-color-11: rgba( 191, 191, 255, 1.00);     /* btn-info:hover */
                        --ACZ-color-12: rgba( 255, 255,   0, 0.10);     /* zebra stripe rows */
                        ...
                        --ACZ-font-color-1: var(--ACZ-color-input);
                        --ACZ-font-color-2: var(--ACZ-color-11);    /* CodeMirror Gutter Numbers */
                        --ACZ-font-color-3: var(--ACZ-color-input);
                        --ACZ-font-color-4: var(--ACZ-color-11);    /* Tabulator cell text */
                        --ACZ-font-color-5: var(--ACZ-color-8);     /* CodeMirror Cursor, TabNav Ok */
                        --ACZ-font-color-6: var(--ACZ-color-9);     /* TabNav Cancel */
                        --ACZ-font-color-7: var(--ACZ-color-16);    /* TabNav Disabled */
                        ...
                        --ACZ-margin-1: 3px;
                        --ACZ-margin-2: 8px;
                        --ACZ-margin-3: 8px 14px 8px 14px; /* SunEditor Footer */
                        ...
                        /* Borders */
                        --ACZ-border-1: 2px solid var(--ACZ-color-15);
                        --ACZ-border-2: 1px solid var(--ACZ-color-16);
                        --ACZ-border-3: 2px solid var(--ACZ-color-15);

                        --ACZ-border-radius-0: 20px;
                        --ACZ-border-radius-1: 16px;
                        --ACZ-border-radius-2: 12px;
                        --ACZ-border-radius-3: 8px;
                        --ACZ-border-radius-4: 10px;  /* Navigator buttons */
                        ...
                        */
                        ...
                        --ACZ-transition-short: 100ms;
                        --ACZ-animation-delay-1: 200ms;
                        ...
                        */
                        --ACZ-tooltips-text: var(--ACZ-color-4);
