-- Migration: acuranzo_1279.lua
-- QueryRef #142 - Revoke OAuth Refresh Token Family (OIDC IdP)
...
cfg.MIGRATION = "1279"
cfg.QUERY_REF = "142"
cfg.QUERY_NAME = "Revoke OAuth Refresh Token Family"
    ...
    SELECT
        ...
        [=[
            ...
            SELECT
                ...
                ${TIMEOUT}                                                          AS query_timeout,
                [==[
                    UPDATE ${SCHEMA}oauth_refresh_tokens
                       SET revoked_at = ${NOW},
                           updated_id = 0,
                           updated_at = ${NOW}
                ...
                [==[
                    ...
                    Revokes all tokens in a rotation family. Parameters: FAMILY_ID.
                ]==]
                                                                                      AS summary,
                '{}'                                                                AS collection,
                ${COMMON_INSERT}
