    ...
    SELECT
        ...
        [=[
            ...
            (
                ...
                client_id               ${CHAR_20}          NOT NULL,
                collection              ${JSON}                     ,
                ${COMMON_CREATE}
                ${PRIMARY}(account_id, client_id)
            );
        ...
        [=[
            ...
            This migration creates the ${TABLE} table for storing account settings data.
            This is intended for a specific client, so with different clients each storing
            a JSON collection of settings that is separate from other clients or versions
            of the same client.
        ]=]
                                                                            AS summary,
        '{}'                                                                AS collection,
