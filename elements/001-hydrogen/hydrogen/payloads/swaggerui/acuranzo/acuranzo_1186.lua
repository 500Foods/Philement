-- Migration: acuranzo_1186.lua
-- LithiumTable style-manager-sections (lookup_id 059, key_idx 9)
...
cfg.LOOKUP_ID = "059"
cfg.KEY_IDX = "9"
cfg.TABLEDEF_NAME = "style-manager-sections"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
    ...
    SELECT
        ...
        [=[
            ...
            VALUES
                ...
                [==[
                    # Style Manager Sections tableDef
