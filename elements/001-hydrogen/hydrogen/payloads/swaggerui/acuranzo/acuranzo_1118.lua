-- Migration: acuranzo_1118.lua
-- QueryRef #027 - Get System Query
...
cfg.MIGRATION = "1118"
cfg.QUERY_REF = "027"
cfg.QUERY_NAME = "Get System Query"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
        ...
        [=[
            ...
            SELECT
                ...
                [==[
                    ...
                    This query retrieves the code, summary, and collection data for a specific system query based on its ID.

                    ## Parameters

                    - `QUERYID` (integer, required): The ID of the system query to retrieve.
