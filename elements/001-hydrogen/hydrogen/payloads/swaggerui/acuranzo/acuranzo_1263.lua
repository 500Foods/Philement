...
-- 1.0.1 - 2026-07-13 - Fixed forward migration: register the CRUD query as a
--                      nested `queries` row (TYPE_SQL) instead of running the
--                      INSERT directly, and mark the migration applied.
...
table.insert(queries,{sql=[[
    ...
    SELECT
        ...
        [=[
            ...
            for the Hydrogen Scripting Subsystem (Scripting Manager CRUD).
        ]=]
                                                                              AS summary,
        '{}'                                                                AS collection,
        ${COMMON_INSERT}
