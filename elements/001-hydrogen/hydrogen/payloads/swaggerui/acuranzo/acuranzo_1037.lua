...
cfg.MIGRATION = "1037"
cfg.LOOKUP_ID = "012"
cfg.LOOKUP_NAME = "Template Status"
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
        ...
        [=[
            ...
            VALUES (
                ...
                [==[
                    ...
                    Categorizes template status as inactive or active.
                ]==],                           -- summary
                ${JSON_INGEST_START}
                [==[
                    {
            ...
            VALUES
                (${LOOKUP_ID}, 0, 1, 'Inactive',    0, 0, '', '', ${JIS}[==[{"icon":"<fa fa-xmark fa-fw fa-swap-opacity style='color: #FF0000; filter: var(--ACZ-shadow-4);'></fa>"}]==]${JIE}, ${COMMON_VALUES}),
                (${LOOKUP_ID}, 1, 1, 'Active',      0, 1, '', '', ${JIS}[==[{"icon":"<fa fa-check fa-fw fa-swap-opacity style='color: #00FF00; filter: var(--ACZ-shadow-4);'></fa>"}]==]${JIE}, ${COMMON_VALUES});
