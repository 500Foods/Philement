...
-- Official DB2 ScalarUDF sample test
CREATE OR REPLACE FUNCTION ${SCHEMA}.ScalarUDF(CHAR(5), DOUBLE)
RETURNS DOUBLE
LANGUAGE C
PARAMETER STYLE DB2SQL
NO SQL
...
NOT FENCED
THREADSAFE
EXTERNAL NAME 'base64_chunk_udf.so!ScalarUDF'
@

-- Smoke tests
VALUES ${SCHEMA}.ScalarUDF('Sales', 25000.00) @
