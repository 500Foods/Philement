...
| **[CATCHUP.md](CATCHUP.md)** | **Active plan** — Phases 0–38 (Course Manager first) |
| [docs/Li/plans/LITHIUM_SPRINT.md](/docs/Li/plans/LITHIUM_SPRINT.md) | Superseded sprint (do not implement) |
