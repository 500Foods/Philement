...
## 13. Style Manager ⬜ NEXT

Theme management: list, apply, edit, share themes. Currently a placeholder stub.
...
- [ ] Create `style-manager/index.js` with init/render/teardown
- [ ] Create `style-manager/style-manager.html` and `.css`
- [ ] **List View:** Tabulator table, New/Apply/Edit/Delete actions
- [ ] **Theme Application:** `applyTheme()`, DOMPurify, dynamic style injection
- [ ] **CSS View:** CodeMirror editor, Apply/Save buttons
- [ ] Feature-gated UI (check `hasFeature()`)
- [ ] Theme data loaded from Hydrogen API
- [ ] `theme:changed` event on apply
...
### Phase 4: Style Manager ⬜ IN PROGRESS
