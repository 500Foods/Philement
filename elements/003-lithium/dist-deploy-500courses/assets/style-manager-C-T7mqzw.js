import { p as processIcons, b as getClaims, h as hasFeature, l as log, S as Status, a as Subsystems, _ as __vitePreload, t as toast } from './index-CNmg4i7Y.js';
/* empty css                          */
import { M as ManagerEditHelper, P as PanelStateManager, L as LithiumSplitter, t as togglePanelCollapse } from './manager-edit-helper-CB5F076B.js';
import { L as LithiumTable } from './lithium-table-main-ClaptTZo.js';
import { s as setupManagerFooterIcons, c as closeAllPopups, p as positionPopup } from './manager-ui-B8HP2uIT.js';
import { a as authQuery } from './conduit-B8Ld7ghl.js';
import { E as EditorState, a as EditorView } from './codemirror-Bg1rM8n2.js';
import { setEditorContentNoHistory, createReadOnlyCompartment, createWordWrapCompartment, createBracketMatchCompartment, createSelectionHighlightCompartment, createCommentContinuationCompartment, createWhitespaceCompartment, createIndentUnitCompartment, createVirtualColumnsCompartment, buildEditorExtensions, setEditorEditable, foldAllInEditor, unfoldAllInEditor } from './codemirror-setup-lxLGSWU-.js';
...
`;
  ...
  prettify() {
    if (this.currentState === 'css' && this.cssEditor) {
      ...
      __vitePreload(async () => { const {formatCode} = await import('./codemirror-Bg1rM8n2.js').then(n => n.Q);return { formatCode }},true              ?[]:void 0,import.meta.url).then(({ formatCode }) => {
        if (formatCode) {
