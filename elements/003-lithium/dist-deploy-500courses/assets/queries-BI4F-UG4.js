const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-C6XHU7h0.js","./_commonjsHelpers-B85MJLTf.js","./index-DLPCDk6c.js","./index-ZlKPF4Cw.css"])))=>i.map(i=>d[i]);
/* empty css                          */
import { P as PanelStateManager, M as ManagerEditHelper, L as LithiumSplitter, t as togglePanelCollapse } from './manager-edit-helper-DrP4BAzu.js';
import { L as LithiumTable } from './lithium-table-main-BZjHbi6_.js';
import { a as authQuery } from './conduit-D2QlMBxM.js';
import { _ as __vitePreload, l as log, a as Subsystems, S as Status, p as processIcons, t as toast } from './index-DLPCDk6c.js';
import { c as closeAllPopups, s as setupManagerFooterIcons, p as positionPopup } from './manager-ui-UMxicChL.js';
...
import { A as AuditInfoFooter } from './audit-info-footer-CKMUQKB-.js';
...
class EditorManager {
  ...
  async handlePrettify() {
    ...
    try {
      ...
      const { toast } = await __vitePreload(async () => { const { toast } = await import('./index-DLPCDk6c.js').then(n => n.G);return { toast }},true              ?__vite__mapDeps([2,3]):void 0,import.meta.url);
