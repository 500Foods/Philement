const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-C6XHU7h0.js","./_commonjsHelpers-B85MJLTf.js","./index-CNmg4i7Y.js","./index-ZlKPF4Cw.css"])))=>i.map(i=>d[i]);
/* empty css                          */
import { P as PanelStateManager, M as ManagerEditHelper, L as LithiumSplitter, t as togglePanelCollapse } from './manager-edit-helper-CB5F076B.js';
import { L as LithiumTable } from './lithium-table-main-ClaptTZo.js';
import { a as authQuery } from './conduit-B8Ld7ghl.js';
import { _ as __vitePreload, l as log, a as Subsystems, S as Status, p as processIcons, t as toast } from './index-CNmg4i7Y.js';
import { c as closeAllPopups, s as setupManagerFooterIcons, p as positionPopup } from './manager-ui-B8HP2uIT.js';
import { createReadOnlyCompartment, createWordWrapCompartment, createBracketMatchCompartment, createSelectionHighlightCompartment, createCommentContinuationCompartment, createWhitespaceCompartment, createVirtualColumnsCompartment, createIndentUnitCompartment, buildEditorExtensions, setEditorEditable, formatSortedJson, updateUndoRedoButtons, foldAllInEditor, unfoldAllInEditor, setEditorContentNoHistory, parseAndSortJson } from './codemirror-setup-lxLGSWU-.js';
import './scrollbar-manager-Bw-KcEhe.js';
import { A as AuditInfoFooter } from './audit-info-footer-CP2R6gh2.js';
import { E as EditorState, a as EditorView, u as undo, r as redo } from './codemirror-Bg1rM8n2.js';
import { L as LithiumEditorFooter, c as createFontPopup } from './font-popup-D81b7hea.js';
import { i as initToolbars } from './toolbar-D02XmjBN.js';
import './tabulator_esm-DsDetXL7.js';
import './languages-Coru4QdC.js';
import './luxon-DbyXf6dF.js';
...
class EditorManager {
  ...
  async handlePrettify() {
    ...
    try {
      const { format } = await __vitePreload(async () => { const { format } = await import('./index-C6XHU7h0.js');return { format }},true              ?__vite__mapDeps([0,1]):void 0,import.meta.url);
      ...
      const { toast } = await __vitePreload(async () => { const { toast } = await import('./index-CNmg4i7Y.js').then(n => n.G);return { toast }},true              ?__vite__mapDeps([2,3]):void 0,import.meta.url);
 ...
 */
function createEditorManager(manager) {
...
export { QueriesManager as default };
