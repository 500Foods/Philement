...
import { l as log, S as Status, a as Subsystems, p as processIcons, c as getRawLog, _ as __vitePreload } from './index-CNmg4i7Y.js';
import { f as formatLogText } from './languages-Coru4QdC.js';
import './manager-ui-B8HP2uIT.js';
import { s as scrollbarManager } from './scrollbar-manager-Bw-KcEhe.js';
import { i as initToolbars } from './toolbar-D02XmjBN.js';
import { c as createFontPopup, L as LithiumEditorFooter } from './font-popup-D81b7hea.js';
...
class SessionLogManager {
  ...
  async populateLog() {
    ...
    try {
      const { EditorState, EditorView } = await __vitePreload(async () => { const { EditorState, EditorView } = await import('./codemirror-Bg1rM8n2.js').then(n => n.R);return { EditorState, EditorView }},true              ?[]:void 0,import.meta.url);
      const { buildEditorExtensions, createReadOnlyCompartment, createWordWrapCompartment, createBracketMatchCompartment, createSelectionHighlightCompartment, createCommentContinuationCompartment } = await __vitePreload(async () => { const { buildEditorExtensions, createReadOnlyCompartment, createWordWrapCompartment, createBracketMatchCompartment, createSelectionHighlightCompartment, createCommentContinuationCompartment } = await import('./codemirror-setup-lxLGSWU-.js');return { buildEditorExtensions, createReadOnlyCompartment, createWordWrapCompartment, createBracketMatchCompartment, createSelectionHighlightCompartment, createCommentContinuationCompartment }},true              ?__vite__mapDeps([0,1]):void 0,import.meta.url);
...
export { SessionLogManager as default };
