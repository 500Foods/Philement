const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-C6XHU7h0.js","./_commonjsHelpers-B85MJLTf.js","./index-CEuz7QhE.js","./index-ZlKPF4Cw.css"])))=>i.map(i=>d[i]);
/* empty css                          */
import { P as PanelStateManager, M as ManagerEditHelper, L as LithiumSplitter, t as togglePanelCollapse } from './manager-edit-helper-DQ3CxLzX.js';
import { L as LithiumTable } from './lithium-table-main-DwQsS17R.js';
import { a as authQuery } from './conduit-B8Ld7ghl.js';
import { _ as __vitePreload, l as log, a as Subsystems, S as Status, p as processIcons, t as toast } from './index-CEuz7QhE.js';
import { c as closeAllPopups, s as setupManagerFooterIcons, p as positionPopup } from './manager-ui-BnjjCmoo.js';
...
import './scrollbar-manager-DHRoVvTV.js';
import { A as AuditInfoFooter } from './audit-info-footer-Dp9IloWB.js';
import { E as EditorState, a as EditorView, u as undo, r as redo } from './codemirror-Bg1rM8n2.js';
import { L as LithiumEditorFooter, c as createFontPopup } from './font-popup-MQtR2cbr.js';
import { i as initToolbars } from './toolbar-CzbXMRHV.js';
...
class EditorManager {
  ...
  async handlePrettify() {
    ...
    try {
      ...
      const { toast } = await __vitePreload(async () => { const { toast } = await import('./index-CEuz7QhE.js').then(n => n.G);return { toast }},true              ?__vite__mapDeps([2,3]):void 0,import.meta.url);
