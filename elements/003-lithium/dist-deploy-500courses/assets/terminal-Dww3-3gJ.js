import { i as initTooltips, p as processIcons, l as log, S as Status, a as Subsystems, _ as __vitePreload } from './index-CEuz7QhE.js';
 ...
 */
function toggleTerminal(options = {}) {
  const terminal = getTerminal();
 ...
 */
function createTerminalButton(tooltip = 'Terminal') {
  ...
  button.addEventListener('click', (e) => {
    ...
    __vitePreload(async () => { const {toggleTerminal} = await Promise.resolve().then(() => terminal);return { toggleTerminal }},true              ?void 0:void 0,import.meta.url).then(({ toggleTerminal }) => {
      toggleTerminal();
    });
  });
...
export { TerminalManager, createTerminalButton, getTerminal, hideTerminal, showTerminal, toggleTerminal };
