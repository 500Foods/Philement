...
- Refactored CONDUIT query handler to use modular helper functions for better testability and coverage `[query.c]`(/elements/001-hydrogen/hydrogen/src/api/conduit/query/query.c)
