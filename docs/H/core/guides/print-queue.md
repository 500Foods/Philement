...
Print queue settings are managed in the configuration file. See the [Configuration Guide](/docs/H/core/reference/configuration.md#print-job-management-printqueue) for detailed settings.
...
- [Configuration Guide](/docs/H/core/reference/configuration.md) for setup
- [API Documentation](/docs/H/core/reference/api.md) for endpoints
- [WebSocket Documentation](/docs/H/core/reference/web_socket.md) for real-time updates
...
Note: This documentation is under active development. Check the [Configuration Guide](/docs/H/core/reference/configuration.md#print-job-management-printqueue) for the most up-to-date settings and options.
