...
For current related information, please refer to [System Architecture](/docs/H/core/reference/system_architecture.md) and [Subsystem Registry Architecture](/docs/H/core/reference/subsystem_registry_architecture.md).
