...
- [Conduit Implementation Plan](/docs/H/plans/complete/CONDUIT_COMPLETE.md) - Full implementation details
- [Cap Query Implementation Plan](/docs/H/plans/complete/CAP_PLAN_QUERY-COMPLETE.md) - This work's planning document
