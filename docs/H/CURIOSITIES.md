...
The Hydrogen project lives in `elements/001-hydrogen/hydrogen/`. While there are related projects like [Deuterium](/elements/001-hydrogen/deuterium/README.md) and [Tritium](/elements/001-hydrogen/tritium/README.md) in the same directory, they are separate initiatives with their own documentation.
...
See [Unity Mocks](/elements/001-hydrogen/hydrogen/tests/unity/mocks/README.md) for detailed mocking strategies.
...
- **[Test 92: Shellcheck](/docs/H/tests/test_92_shellcheck.md)** requires justification for exceptions
...
- **[Test 93: JSONLint](/docs/H/tests/test_93_jsonlint.md)**: Validates JSON file syntax and structure
- **[Test 94: ESLint](/docs/H/tests/test_94_eslint.md)**: Lints JavaScript files using eslint
...
- [DB2](/elements/001-hydrogen/hydrogen/.sqruff_db2) - DB2-specific sqruff rules
- [MySQL/MariaDB](/elements/001-hydrogen/hydrogen/.sqruff_mysql) - MySQL/MariaDB-specific sqruff rules
- [PostgreSQL](/elements/001-hydrogen/hydrogen/.sqruff_postgresql) - PostgreSQL-specific sqruff rules
- [SQLite](/elements/001-hydrogen/hydrogen/.sqruff_sqlite) - SQLite-specific sqruff rules
...
**[Test Suite Results](/elements/001-hydrogen/hydrogen/images/COMPLETE.svg)** ([view SVG](/elements/001-hydrogen/hydrogen/images/COMPLETE.svg)):
...
- Generated only during [Test 01: Compilation](/docs/H/tests/test_01_compilation.md)

**[Test Suite Coverage](/elements/001-hydrogen/hydrogen/images/COVERAGE.svg)** ([view SVG](/elements/001-hydrogen/hydrogen/images/COVERAGE.svg)):

- Per-file coverage analysis (200+ files, 4,000+ tests, 20,000+ lines)
- Metrics: lines of code, test counts, coverage percentages
- Generated via [Coverage Table](/docs/H/tests/coverage_table.md) script

**[Code Metrics (CLOC)](/elements/001-hydrogen/hydrogen/images/CLOC_CODE.svg)** ([view SVG](/elements/001-hydrogen/hydrogen/images/CLOC_CODE.svg)):
...
**[Enhanced Metrics](/elements/001-hydrogen/hydrogen/images/CLOC_STAT.svg)** ([view SVG](/elements/001-hydrogen/hydrogen/images/CLOC_STAT.svg)):
