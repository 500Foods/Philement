...
- [print_queue.md](docs/print_queue.md)
- [service.md](docs/service.md)
- [shutdown_architecture.md](docs/shutdown_architecture.md)
...
- [system_health.md](docs/api/system/system_health.md)
- [system_info.md](docs/api/system/system_info.md)
- [system_version.md](docs/api/system/system_version.md)
...
- [ai_development.md](docs/development/ai_development.md)
- [coding_guidelines.md](docs/development/coding_guidelines.md)

### Folder: /docs/guides

- [print-queue.md](docs/guides/print-queue.md)
...
- [mdns_configuration.md](docs/reference/mdns_configuration.md)
- [network_architecture.md](docs/reference/network_architecture.md)
- [oidc_architecture.md](docs/reference/oidc_architecture.md)
- [print_queue_architecture.md](docs/reference/print_queue_architecture.md)
- [print_subsystem.md](docs/reference/print_subsystem.md)
- [printqueue_configuration.md](docs/reference/printqueue_configuration.md)
- [resources_configuration.md](docs/reference/resources_configuration.md)
- [smtp_configuration.md](docs/reference/smtp_configuration.md)
- [smtp_relay_architecture.md](docs/reference/smtp_relay_architecture.md)
- [subsystem_registry_architecture.md](docs/reference/subsystem_registry_architecture.md)
- [swagger_architecture.md](docs/reference/swagger_architecture.md)
- [swagger_configuration.md](docs/reference/swagger_configuration.md)
- [system_architecture.md](docs/reference/system_architecture.md)
- [system_info.md](docs/reference/system_info.md)
- [terminal_architecture.md](docs/reference/terminal_architecture.md)
- [web_socket.md](docs/reference/web_socket.md)
- [webserver_configuration.md](docs/reference/webserver_configuration.md)
- [webserver_subsystem.md](docs/reference/webserver_subsystem.md)
- [websocket_architecture.md](docs/reference/websocket_architecture.md)
- [websocket_configuration.md](docs/reference/websocket_configuration.md)
- [websocket_subsystem.md](docs/reference/websocket_subsystem.md)

### Folder: /docs/reference/launch

- [payload_subsystem.md](docs/reference/launch/payload_subsystem.md)
- [threads_subsystem.md](docs/reference/launch/threads_subsystem.md)
- [webserver_subsystem.md](docs/reference/launch/webserver_subsystem.md)
...
- [TESTING.md](tests/TESTING.md) - How to use and update the Test Suite
- [TESTING_UNITY.md](tests/TESTING_UNITY.md) - How to create new Unity Unit Test Framework tests
...
- [test_70_installer.md](tests/docs/test_70_installer.md): Standalone installer building test
...
- [test_97_xmlstarlet.md](tests/docs/test_97_xmlstarlet.md): XML/SVG validation tests
- [test_80_code_size.md](tests/docs/test_80_code_size.md): Code size analysis and metrics
